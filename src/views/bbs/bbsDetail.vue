<template>
  <div class="page">
    ...
    <main class="b-b-b">
      <div class="bbs-detail">
        ...
        <div class="d-b">
          ...
          <div class="b-r">
            <span><i class="mvfont mv-kan" />876</span>
        ...
        <div class="d-d">
          <img :src="getAssetsFile('temp/m1.jpg')" />
          <img :src="getAssetsFile('mv/m1.jpg')" />
          <img :src="getAssetsFile('temp/m2.jpg')" />
          <img :src="getAssetsFile('mv/m2.jpg')" />
        </div>
        <div class="d-comment-list">
          <div class="dc-a">
            <div class="a-l"><i class="mvfont mv-xietiao" />评论<b>24</b></div>
            <div class="a-r" />
          </div>
          <div class="dc-b">
            <div class="item">
              ...
              <div class="i-r">
                <div class="r-a">
                  ...
                  <div class="ra-r">
                    <i class="mvfont mv-zan" />
                    <span>29</span>
                  </div>
                </div>
                <div class="r-b">这个是评论内容，先占个位置，这个是评论内容，先占个位置这个是评论内容，先占个位置这个是评论内容，先占个位置。</div>
              </div>
            </div>
            <div class="item">
              <div class="i-l" :style="{ backgroundImage: `url(${getAssetsFile('u_video.png')})` }" />
    ...
    <footer class="footer">
      <div class="p-comment">
        <div class="c-l"><input placeholder="说点什么吧" /></div>
        <div class="c-r">
          <span>
            <i class="mvfont mv-zan" />
            <small>10</small>
