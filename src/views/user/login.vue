          ...
          <div class="lp-r">
            <a href="#">
              <svg width="100%" height="1em" viewBox="0 0 355.508 405.592" xmlns="http://www.w3.org/2000/svg" font-size="1.3rem" class="sc-bCBNXU bvpEFf">
                ...
                />
                <path fill="#211E1F" d="M276.995 124.88v191.384c0 5.528-3.502 10.322-8.416 12.16l-88.865 34.457-88.896-34.457c-4.886-1.838-8.416-6.632-8.416-12.16l.013-191.384h194.58" />
                <path
                  fill="none"
                  stroke="#FFF"
                  stroke-width="2.356"
                ...
                />
                <path fill="#FFF" d="M87.027 272.62V154.673h185.296l.035 117.947H87.027" />
                <path
                  fill="#ED1A3B"
                ...
                />
                <path fill="#FFC40D" d="M178.834 298.555c-2.921 0-5.313 2.404-5.313 5.343a5.301 5.301 0 005.313 5.342c2.982 0 5.375-2.336 5.375-5.342 0-2.938-2.392-5.343-5.375-5.343" />
                <path
                  fill="none"
                  stroke="#FFC40D"
                  stroke-width="0.571"
                ...
                />
                <path fill="#FFF" d="M67.603 99.81l5.487 10.956c3.904-3.281 8.065-7.186 12.505-10.905L75.313 81.499c3.703 7.137-1.346 13.145-7.71 18.311" />
                <path fill="#ED1A3B" d="M52.438 115.866c.279.421.698.783 1.259 1.159 5.532 3.904 12.023-.077 19.392-6.259L67.603 99.81c-8.166 6.583-18.529 11.749-15.165 16.056" />
                <path
                  fill="none"
                  stroke="#211E1F"
                  stroke-width="4.704"
                ...
                />
                <path fill="#FFF" d="M287.87 99.81l-5.479 10.956c-3.897-3.281-8.089-7.186-12.47-10.905l10.254-18.362c-3.71 7.137 1.355 13.145 7.695 18.311" />
                <path fill="#ED1A3B" d="M303.054 115.866c-.31.421-.74.783-1.255 1.159-5.565 3.904-12.006-.077-19.409-6.259l5.479-10.956c8.176 6.583 18.518 11.749 15.185 16.056" />
                <path
                  fill="none"
                  stroke="#211E1F"
                  stroke-width="4.704"
                ...
                />
                <path fill="#FFF" d="M178.519 62.854c27.778 0 50.367-9.026 50.367-20.155 0-11.1-22.589-20.115-50.367-20.115-27.808 0-50.361 9.016-50.361 20.115 0 11.129 22.552 20.155 50.361 20.155" />
                <path
                  fill="none"
                  stroke="#211E1F"
                  stroke-width="9.436"
            ...
            <a href="#">
              <svg fill="none" width="1em" height="1em" viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg" font-size="1.3rem" class="sc-dAQVOH bzAftO">
                <clipPath id="a"><path d="m0 0h22v22h-22z" /></clipPath>
                <g clip-path="url(#a)" clip-rule="evenodd" fill-rule="evenodd">
                  <path d="m0 8.55637v-8.55637h21.9995v8.53313l-10.9988 13.46737z" fill="#fff" />
                  <path d="m1.25623 8.1723 8.02245 9.7914v-9.7914z" fill="#d71920" />
                  <g fill="#001522">
                    <path d="m20.7439 8.17279-8.0225 9.79141v-9.79141z" />
                    <path
            ...
            <a href="#">
              ...
              >
                <g>
                  <g>
                    <line class="st0" x1="4" y1="12" x2="4" y2="11.9" />
                    <path
                      class="st0"
                  ...
                  <g>
                    <line class="st0" x1="18" y1="11.9" x2="18" y2="12" />
                    <path
                      class="st0"
