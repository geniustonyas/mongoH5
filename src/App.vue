...
if (route.query.fb_dynamic_pixel && route.query.fb_dynamic_pixel != '' && window.location.hostname.indexOf('seabet88.io')) {
...
const fb_id = localStorage.getItem('fb_id')
let fb_timer = null
if (fb_over_time && fb_id && window.location.hostname.indexOf('seabet88.io') > -1) {
