export default {
  ...
  regPage: {
    ...
    termCondition: '规则与条款',
    privacyPolicy: '隐私政策',
    isAgree: `我同意接受SEABET的促销和活动相关的市场信息。`
  },
  thirdRegPage: {
    beFinished: '快完成了哦！',
    fixInfo: '请补充完整您的资料'
  ...
  step: '步骤',
  clickSave: '点击工具栏上的“分享”按钮',
  addDesk: `从菜单中选择“添加到主屏幕”`,
  clickAdd: `点击“添加”完成安装`,
  iosFinish: `从您的 iOS 设备主屏幕启动SEABET.IO应用程序`,
  ...
  retentionA2: '无需注册，所有注册成功的会员都将有专属链接，点击菜单栏中“联盟计划”即可查看。',
  ...
  commissionA2: '每当玩家在我们的网站上下注时，您就会获得该玩家收入的一定百分比。您的利润=（游戏内总输赢–奖励–网络费用–存提手续费）x（您的佣金百分比）。',
  commissionQ2Desc: '●网络费用=游戏内总输赢*10%',
  ...
  vip: {
    ...
    vipWel: `<p>欢迎来到<b>Seabet</b>尊贵会员俱乐部</p>
    ...
    vipManage: `<dt>VIP专属经理</dt>
                <dd>只关注您的需求</dd>
                <dd>定制私人游戏体验</dd>`,
    vipHighReward: ` <dt>高额奖励</dt>
                      <dd>免下注奖励</dd>
                      <dd>快速积分累积</dd>`,
    highLimit: `<dt>定制体验</dt>
                <dd>无限次存取款</dd>
                <dd>最高投注限制</dd>`,
    vipPromotion: `<dt>VIP专属促销</dt>
                    <dd>个性化优惠</dd>
                    <dd>专享VIP可见</dd>`,
    noQueue: `<dt>24/7优质服务</dt>
              <dd>快捷多语服务</dd>
              <dd>专属客户经理</dd>`,
    vipRewardDetailsTitle: 'VIP奖励明细',
    vipRewardDetails: `<h2>VIP奖励明细</h2>
                      <p>升级即可获得独家访问权限，享受丰厚奖励和个性化礼物！加入我们的精英玩家社区，体验在线游戏的最佳享受!</p>`,
    subTitle: {
      '102': '青铜1',
      '103': '白银1-5',
      '104': '黄金1-8',
    ...
    howBeVipTitle: '如何成为我们的VIP会员',
    howBeVipContent: `<dd>
                        继续投注：成为 VIP 的关键是始终投注各种体育赛事和赌场游戏。Seabet 将奖励您的一致性。作为顶级加密博彩网站，请定期使用您的数字资产对 Seabet
                        提供的任何赛事和赌场游戏进行投注。也可以尝试 USDT 投注，并持续使用您的资金。
                      </dd>
                      <dd>
  ...
  html: {
    ...
    rulesContent: `<div>
                    ...
                    <p><b>5.2 </b>如果违反提及的任何陈述、认股权证或契约，Seabet保留自行决定关闭或暂停您的Seabet账户并在法律适用的范围内取消任何投注的权利。</p>
                    ...
                    <p>（iii） Seabet错误地计算或支付结算金额，包括投注被兑现为全部结算金额，或投注错误地无效，在下注时选择了“如果玩家未开始，则无效”;或任何游戏或产品中包含、合并或使用的随机数生成器或付费表发生任何错误。</p>
    ...
    fairnessContent: `<div>
                        ...
                        <p><b>11.15</b>本网站所提供的实时视频流、统计数据、实时比分以及现场投注等信息，皆为增值信息服务。然而，本网站不承担任何责任，无论出现任何信息的不准确或错误。</p>
                        ...
                        <p><b>11.22 </b>以下与提现功能有关：</p>

                        <p><b>11.22.1 </b>提现适用于赛前和赛中选定的赛事、赛程和盘口，单次和多次投注。</p>

                        <p><b>11.22.2 </b>接受提现请求的时间延迟。如果价格或市场发生变化暂停，则提现请求可能无法成功。</p>

                        <p><b>11.22.3</b>若提现申请获得批准，相应的投注款项将立即显示并进行结算。原先投注的实际最后结果并不会对提现进程产生影响。</p>

                        <p><b>11.22.4 </b>在任何情况下，成功提出提现请求后，退款的总金额将返回到您的账户。</p>

                        <p><b>11.22.5 </b>本网站不能保证您的投注可以使用提现功能选择。如果活动前有提现，我们不承保或停止承保赛事滚球，一旦赛事开始或我们的滚球赛，提现将不可用覆盖范围停止。当市场暂停时，将不提供提现。</p>

                        <p><b>11.22.6 </b>本网站保留对客户或客户群进行全面或部分撤回功能剥离的权利。在合理怀疑客户或客户群滥用提现功能以利用活动前价格变动，或经常性使用提现功能来在活动开始前关闭投注的情况下，我们将行使该权利。</p>

                        <p><b>11.22.7 </b>如果于技术原因导致提现功能不可用，本网站将不对此负责。此外，在此类情况下的任何投注行为将维持其原始的下注状态，本网站同样不承担任何责任。</p>

                        <p><b>11.22.8 </b>本网站保留接受或拒绝任何投注/投注的权利套现功能中包含的体育、比赛、市场或投注类型。</p>

                        <p><b>11.23 </b>最高奖金以美元作为基础货币报价，以确保 世界，但货币等值适用于实际支出。多重投注的位置其中涉及具有不同最高奖金限额的赛事，则将适用最低限额。都最高奖金限额适用于我们所有的客户或客户群，他们使用不同的投注账户以不同的价格包含相同选择的投注。应该我们有理由相信，已经有好几个赌注是这样下注的，全部支付这些投注加起来将仅限于一次最高奖金支付。</p>
