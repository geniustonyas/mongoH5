    ...
    vipContent: `
      <div class="vip-clubhouse-box">
        ...
        <div class="vc-rows">
          ...
          <div class="vr-conts">
            <dl>
              ...
              <dd>近期游戏表现奖金：运气不佳？Seabet会在您每次升级时根据您的损失提供额外资金</dd>
        ...
        <div class="vc-rows">
          ...
          <div class="vr-conts">
            <p>Seabet贵宾会员俱乐部是以玩家投注额为基础，以每个自然月1日00:00开始计算到每月最后一天的23:59为计算周期，在计算周期内，玩家达到相应的投注金额即可晋级同时享受晋级后的等级待遇。</p>
            <table>
              <tr>
                <th>VIP等级</th>
                <th>所需投注额</th>
        ...
        <div class="vc-rows">
          ...
          <div class="vr-conts">
            ...
            <p class="mark">
              ...
              积分系数说明：积分系数决定玩家获取积分的速度与倍数，Seabet积分获取公式为玩家在任意场馆的投注金额*0.1*对应级别的积分系数，如玩家等级为铂金，投注金额为5000，那么根据积分计算公式，该玩家所获积分为5000*0.1*1.3=650积分。Seabet积分用途广泛，玩家可通过积分在积分商城中兑换等值礼品及服务项目。
            </p>
          </div>
        </div>
        <div class="vc-rows">
