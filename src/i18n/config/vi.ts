export default {
  ...
  regPage: {
    ...
    isAgree: `Tôi đồng ý nhận thông tin về các hoạt động tiếp thị và sự kiện liên quan từ SEABET.`
  },
  thirdRegPage: {
  ...
  liveCasinoBet: 'Cược Casino trực tuyến',
  slotBet: 'Cược Slots',
  more: 'Thêm',
  loadMore: 'Tải thêm',
  ...
  demoMode: 'Chơi Vu',
  trueMode: 'Chơi Thật',
  gameCurrency: 'Tiền tệ trong trò chơi',
  gameStatic: 'Trạng thái trò chơi',
  ...
  affiliateTitle: 'Chương trình Liên kết Toàn cầu',
  overview: 'Tổng quan',
  advantage: 'Ưu điểm',
  affiliateQuestion: 'Câu hỏi thường gặp',
  overviewDesc: `SEABET.IO là nền tảng cá cược dựa trên tiền điện tử tốt nhất. Chúng tôi cung cấp một nền tảng công bằng, an toàn và bao gồm cho người chơi quan tâm đến thể thao trực tiếp, sòng bài trực tiếp và các trò cá cược máy đánh bạc, cung cấp hơn 420.000 sự kiện trước trận và hàng ngàn trò chơi máy đánh bạc video khác nhau, bàn chơi và trò chơi trực tiếp do các nhà cung cấp hàng đầu thế giới phát triển. SEABET.IO đã thấy sự tăng trưởng kỷ lục và chúng tôi mời bạn tham gia vào câu chuyện thành công của chúng tôi.`,
  bePartner: 'Trở thành Đối tác',
  howBePartner:
    'Quảng cáo SEABET.IO và kiếm lợi nhuận lên đến 50% mà không cần điểm mốc! Chúng tôi cung cấp dịch vụ bằng 11 ngôn ngữ với quản lý khu vực riêng biệt nhắm mục tiêu đến các khu vực khác nhau trên thế giới!',
  ...
  retentionQ1: '1. Chương trình liên kết là gì?',
  retentionA1:
  ...
  retentionA4:
    'Chương trình liên kết Seabet.io hoàn toàn miễn phí! Mục tiêu của chúng tôi là giúp bạn quảng cáo thương hiệu của chúng tôi và chúng tôi rất vui mừng để thưởng cho những nỗ lực của bạn.',
  retentionQ5: '5. Làm thế nào để bắt đầu quảng cáo?',
  retentionA5: 'Bạn có thể quảng cáo một cách hiệu quả thông qua nhiều kênh mà không cần trang web của riêng bạn, chẳng hạn như Facebook, Twitter, LinkedIn, Telegram, WhatsApp, diễn đàn, v.v.',
  retentionQ6: '6. Điều gì làm cho Seabet.io khác biệt so với các trang web khác?',
  retentionA6:
    'Seabet.io có tất cả những kỳ vọng mà bạn sẽ có từ hầu hết các chương trình liên kết. Điều làm nên sự khác biệt của Seabet.io là đội ngũ đội ngũ đột phá của chúng tôi. Chúng tôi đảm bảo dịch vụ nhanh nhất có thể cho khách hàng và khách hàng liên kết của chúng tôi, phần thưởng, sự trung thành và dịch vụ đa ngôn ngữ và toàn cầu của chúng tôi.',
  commission: 'Hoa hồng',
  ...
  commissionQ4: '4. Các số dư âm sẽ được chuyển sang tháng tiếp theo không?',
  commissionA4:
    'Hoa hồng của bạn có thể bị ảnh hưởng khi người chơi bạn giới thiệu chiến thắng, vì chúng tôi trừ điểm chiến thắng đó khỏi doanh thu. Tuy nhiên, tình hình này thường không kéo dài lâu.',
  commissionQ5: '5. Hoa hồng được thanh toán thường xuyên như thế nào?',
  commissionA5:
    'Hoa hồng liên kết của bạn sẽ được tự động thanh toán trong vòng 5 ngày làm việc đầu tiên của mỗi tháng. Tiền sẽ được thêm vào tài khoản người chơi của bạn và bạn có thể rút hoặc sử dụng hoa hồng để cược trên trang web bất cứ lúc nào.',
  commissionQ6: '6. Tôi có thể giới thiệu chính mình không?',
  commissionA6: 'Không, chương trình liên kết của chúng tôi không ủng hộ thực hành này. Nó sẽ được xem xét là hành vi gian lận.',
  commissionQ7: '7. Chương trình liên kết có chấp nhận tất cả các trang web không?',
  commissionA7: `Chúng tôi không quảng cáo quảng cáo cho trẻ em hoặc trang web dành cho người lớn. Chúng tôi phản đối quảng cáo có sự hạn chế; bất kỳ thành viên nào sử dụng các phương pháp như vậy sẽ bị cấm khỏi chương trình của chúng tôi và chúng tôi bảo lưu quyền khởi kiện chống lại bất kỳ thành viên nào sử dụng trang web này để bảo vệ trang web của chúng tôi. Vui lòng tham khảo các quy tắc và điều khoản của chúng tôi để biết thêm thông tin.`,
  report: 'Báo cáo',
  memberManager: 'Quản lý thành viên',
  commissionReport: 'Báo cáo hoa hồng',
  financeReport: 'Báo cáo tài chính',
  affiliateSupport: 'Hỗ trợ',
  advantageTitle: 'Ưu điểm của SEABET.IO',
  advantageQ1: 'Thống kê chi tiết',
  advantageA1: 'Hệ thống liên kết độc đáo của chúng tôi cung cấp cập nhật nhanh chóng và cho phép bạn theo dõi các người chơi cấp dưới, xem chi tiết người chơi và dữ liệu liên kết.',
  advantageQ2: 'Lợi nhuận trọn đời',
  advantageA2:
    'Như thường lệ, khả năng kiếm lợi nhuận của bạn là không giới hạn và càng nhiều lưu lượng bạn đưa vào, bạn sẽ nhận được nhiều thu nhập hơn. Cấu trúc thanh toán hào phóng của chúng tôi cho phép bạn có lợi nhuận từ mỗi người chơi.',
  advantageQ3: 'Thanh toán liên kết nhanh chóng',
  advantageA3: 'Thanh toán liên kết nhanh chóng. Chúng tôi thanh toán hoa hồng trong vòng 5 ngày làm việc đầu tiên của mỗi tháng.',
  advantageQ4: 'Thương hiệu hàng đầu',
  advantageA4: 'Chúng tôi tự hào về dịch vụ xuất sắc và chúng tôi ở đây để cung cấp cho bạn nhiều cách khác nhau để xây dựng thương hiệu hàng đầu trên thị trường.',
  advantageQ5: 'Hướng dẫn địa phương',
  advantageA5: 'Hưởng lợi từ hướng dẫn và hỗ trợ từ quản lý khu vực của chúng tôi có hơn 10 năm kinh nghiệm trong ngành công nghiệp trò chơi trên toàn thế giới.',
  childMemberList: 'Danh sách các thành viên cấp dưới',
  memberAccount: 'Tài khoản thành viên',
  statTime: 'Thời gian thống kê',
  isBet: 'Có cược',
  regTime: 'Thời gian đăng ký',
  totalWinLose: 'Tổng chiến thắng/thua',
  lastLoginTime: 'Lần đăng nhập cuối',
  bonus: 'Tiền thưởng',
  refund: 'Hoàn trả',
  venueFee: 'Phí sân vận động',
  depositFee: 'Phí nạp tiền',
  jingWinLose: 'Số tiền thắng/thua ròng',
  accountTz: 'Điều chỉnh tài khoản',
  manage: 'Quản lý',
  dashboard: 'Bảng điều khiển',
  memberInfo: 'Thông tin thành viên',
  memberRecord: 'Hồ sơ thành viên',
  memberDeposit: 'Lịch sử nạp tiền thành viên',
  childMember: 'Thành viên cấp dưới',
  firshRecharge: 'Số lần nạp lần đầu',
  newRegMonth: 'Đăng ký mới trong tháng này',
  newRegValid: 'Thành viên mới hợp lệ',
  ...
  filter: 'Lọc',
  agentDepositLimit: 'Giới hạn nạp tiền đại lý',
  canUseLimit: 'Số dư khả dụng',
  agentDepositRecord: 'Lịch sử nạp tiền đại lý',
  yes: 'Có',
  no: 'Không',
  childAccount: 'Tài khoản cấp dưới',
  inputChildAccount: 'Nhập tài khoản cấp dưới',
  agentDepositAmount: 'Số tiền nạp của đại lý',
  inputAgentDepositAmount: 'Nhập số tiền nạp của đại lý',
  singleAgentDepositAmount: 'Số tiền nạp đơn lẻ của đại lý',
  agentDepositDayLimit: 'Giới hạn nạp hàng ngày',
  withdrawFlowMult: 'Hệ số rút tiền',
  inputWithdrawFlowMult: 'Nhập hệ số rút tiền',
  multiple: 'Hệ số',
  remark: 'Ghi chú',
  inputRemark: 'Nhập ghi chú',
  loginPwd: 'Mật khẩu đăng nhập',
  inputLoginPwd: 'Nhập mật khẩu đăng nhập',
  optime: 'Thời gian thực hiện',
  agentDepositStatus: {
    0: 'Thất bại',
    1: 'Thành công'
  },
  monthDetailsData: 'Dữ liệu chi tiết hàng tháng',
  releaseTime: 'Thời gian phát hành',
  activityUser: 'Người dùng hoạt động',
  netFee: 'Phí mạng',
  ctfee: 'Phí nạp/ rút tiền',
  lastMonthRemain: 'Số dư tháng trước',
  infactCommission: 'Hoa hồng thực tế',
  today: 'Hôm nay',
  yestoday: 'Hôm qua',
  ...
  rewardDetails: 'Chi tiết thưởng',
  winLoseTip:
    'Lưu ý: Số dương trong tổng số tiền thắng/thua và số tiền thắng/thua ròng cho thấy lợi nhuận của công ty, trong khi số âm cho thấy thua lỗ của công ty. Dữ liệu hàng ngày chỉ để tham khảo chung và không phải là tiêu chuẩn thanh toán hoa hồng thực tế.',
  recommendLink: 'Liên kết giới thiệu',
  downloadBanner: 'Tải xuống biểu ngữ',
  childAccountNotExist: 'Tài khoản cấp dưới không tồn tại',
  depositAmountLimit: 'Số tiền nạp của đại lý vượt quá giới hạn giao dịch đơn lẻ',
  withdrawFlowMultLimit: 'Hệ số rút tiền vượt quá giới hạn',
  agentDepositSuccess: 'Nạp tiền của đại lý thành công',
  mustBeNumber: '{ tmp } phải là số',
  inputAccountStart: 'Nhập tài khoản thành viên để bắt đầu tìm kiếm',
  ...
  keepContact: 'Hãy giữ liên lạc',
  subscribe: 'Đăng ký',
  subscribeEmail: ' đăng ký  Email',
  ...
  vip: {
    ...
    vipWel: `<p>Chào mừng đến với Seabet VIP Club</p>
              <p>Tại Seabet, chúng tôi cam kết nâng cao chất lượng trò chơi và cung cấp trải nghiệm chơi game tốt nhất. Chúng tôi cho ra mắt câu lạc bộ VIP hoàn toàn mới để thưởng cho những thành viên của chúng tôi, người dành thời gian chơi trò chơi trên trang web của chúng tôi một cách trung thành.</p>
              <p>Chỉ cần đặt cược trên bất kỳ trò chơi hoặc sự kiện thể thao nào được cung cấp bởi Seabet.io, và sau khi bạn lên cấp bậc sẽ mở khóa nhận được những phần thưởng độc quyền.</p>`,
    vipManage: `<dt>Quản lý Độc quyền VIP</dt>
                <dd>Được cá nhân hóa theo nhu cầu</dd>
                <dd>Trải nghiệm chơi game tùy chỉnh</dd>`,
    vipHighReward: ` <dt>Phần thưởng cao</dt>
                      <dd>Khuyến mãi không cần đặt cược</dd>
                      <dd>Tích lũy điểm nhanh</dd>`,
    highLimit: `<dt>Trải nghiệm đặt cược tùy chỉnh</dt>
                <dd>Giao dịch không giới hạn</dd>
                <dd>Giới hạn cược tối đa cao hơn</dd>`,
    vipPromotion: `<dt>Khuyến mãi độc quyền VIP</dt>
                    <dd>Ưu đãi cá nhân</dd>
                    <dd>Chỉ dành cho VIP</dd>`,
    noQueue: `<dt>Dịch vụ hàng đầu 24/7</dt>
              <dd>Hỗ trợ đa ngôn ngữ nhanh chóng</dd>
              <dd>Quản lý tài khoản cá nhân</dd>`,
    vipRewardDetailsTitle: 'Chi tiết Phần thưởng VIP',
    ...
    subTitle: {
      ...
      '106': 'Cấp độ Titan 1-10',
      '107': 'Cấp bậc kim cương 1-6'
    },
    usdtAmount: 'Số tiền đặt cược',
    amount: {
      '102': '$100 USDT',
      '103': '$500-$10K USDT',
      '104': '$15K-$190K USDT',
    ...
    vipRewardDetailContent: `<dd>Tiền thưởng qua email khuyến mãi sẽ được gửi qua email khuyến mãi với một mã code. Sử dụng mã code để đổi quà trên trang "Phần thưởng".</dd>
                            ...
                            <dd>Tất cả các giai đoạn tính toán tiền thưởng sẽ sử dụng Giờ Hong Kong, Trung Quốc (UTC+8).</dd>`,
    howBeVipTitle: 'Cách trở thành thành viên VIP của chúng tôi',
    howBeVipContent: `<dd>
