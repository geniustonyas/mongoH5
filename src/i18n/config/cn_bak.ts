export default {
  ...
  // 上方菜单
  odds: '赔率',
  handicapType: { 1: '欧洲盘', 2: '香港盘', 3: '马来盘', 4: '印尼盘' },
  sortType: { 1: '按热门', 2: '按日期', 3: '按联赛' },
  ...
  liveStatic: '统计',
  headToHead: '对决',
  viewAllOption: '查看所有多个选项',

  // 投注记录
  betDate: '投注日期',
  betDesc: '投注摘要',
  dateArr: ['今日', '昨日', '近7天', '近30天', '自选'],
  selectDate: '选择日期',
  matchStartTime: '开赛日期',
  settleStatus: ['未结算注单', '已结算注单'],
  orderType: { 1: '单式', 2: '复式', 3: '冠军' },
  no: '编号',
  betStake: '投注额',
  winLose: '赢/输',
  status: '状态',
  ...
  //   nextPage: '下一页',
  //   total: '总计',
  settleResult: { 10: '赢', 11: '赢一半', 20: '输', 21: '输一半', 30: '和', 50: '取消', 60: '取消', 99: '系统拒绝' },
  cancelReason: { 1: '盘口关闭', 2: '赔率错误', 3: '盘口错误', 4: '赛事取消', 5: '赛事延期', 6: '比分错误', 7: '卫星信号中断', 8: '罚牌错误', 9: '危险球', 10: '赛事中断' },
  resultScore: {
    1: { 0: '全场', 1: '上半场' },
    2: { 0: '全场', 1: '第一节', 2: '第二节', 3: '第三节', 4: '第四节', 6: '上半场', 7: '下半场' },
    3: { 0: '全场', 1: '第一盘', 2: '第二盘', 3: '第三盘', 4: '第四盘', 5: '第五盘', 6: '局' },
    4: { 0: '全场', 1: '前五局' }
  },

  // store 中的相关配置
  handicaps: ['', '欧洲盘', '香港盘', '马来盘', '印尼盘'],
  handicapTypeName: ['大', '小', '单', '双'],
  ...
  thead: {
    ...
    t2ou: '第2队得分',
    oddEven: '单/双',
    bothTeamsToScore: 'Cả hai đội điểm',
    otherScore: '其他比分',
  ...
  seconds: {
    qs: ['第一节', '第二节', '第三节', '第四节', '第五节'],
    sets: ['第一盘', '第二盘', '第三盘', '第四盘', '第五盘'],
    games: ['第一局', '第二局', '第三局', '第四局', '第五局']
  },
  ls: {
    Q1: '第一节',
    Q2: '第二节',
