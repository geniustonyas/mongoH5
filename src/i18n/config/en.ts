export default {
  ...
  regPage: {
    ...
    isAgree: `I agree to receive marketing information about SEABET promotions and events. `
  },
  thirdRegPage: {
  ...
  changePwdLimit: 'To ensure the security of your funds, you will not be able to withdraw to a new wallet address within 24 hours after changing your password.',
  ...
  liveCasinoBet: 'Live Casino Bets',
  slotBet: 'Slots Bets',
  more: 'More',
  loadMore: 'Load more',
  providers: 'Providers',
  ...
  tips: {
    ...
    isAudit: 'Please confirm that you are of legal age and accept the privacy policy.',
    isAgree: 'Please read and accept relevant marketing campaign information.',
    ...
    inputHotelName: 'Please type in the hotel name',
  ...
  startNow: 'Play Now',
  withdrawStatus: { 1: 'Processing', 2: 'Confirmed', 3: 'Rejected' },
  time: 'Time',
  betAmount: 'Bet Amount',
  support2: 'Support',
  btiSportIntro: 'With years of experience in sports platform operation, the Seabet sports betting platform offers players an immersive and optimized sports betting gaming experience.',
  ...
  fundRecord: 'Transaction history',
  ...
  demoMode: 'Fun Play',
  trueMode: 'Real Play',
  gameCurrency: 'In-game currency',
  gameStatic: 'Game stats',
  receivedSuccess: '{ amount } USDT Claimed',
  receivedSuccess2: '{ amount } { currency } Claimed',
  ...
  inputBacktime: 'Please select return time',
  inputInTime: 'Please select check-in time',
  inputOutTime: 'Please select check-out time',
  hotelTimeError: 'Check-out time cannot be earlier than check-in time',
  ticketTimeError: 'Return time cannot be earlier than departure time',
  countryHolder: 'Country Code',
  ...
  favariateGame: 'Favourites',
  recentlyGame: 'Recently played',
  ...
  affiliateTitle: 'Global Affiliate Program',
  overview: 'Overview',
  advantage: 'Advantages',
  affiliateQuestion: 'Frequently Asked Questions',
  overviewDesc: `SEABET.IO is the best cryptocurrency-based betting platform. We provide a fair, secure, and inclusive platform for players interested in live sports, live casinos, and slot betting games, offering over 420,000 pre-match events and thousands of different video slots, gaming tables, and live dealer games developed by world-leading providers. SEABET.IO has seen record-breaking growth, and we invite you to be a part of our success story.`,
  bePartner: 'Become a Partner',
  howBePartner: 'Promote SEABET.IO and earn up to 50% revenue share with no quotas! We offer services in 11 languages with dedicated regional managers targeting different parts of the world!',
  ...
  retentionQ1: '1. What is the affiliate program?',
  retentionA1:
  ...
  retentionA4: 'The Seabet.io affiliate program is completely free! Our goal is to help you promote our brand, and we are happy to reward your efforts.',
  retentionQ5: '5. How do I start promoting?',
  retentionA5: 'You can effectively promote through various channels without having your website, such as Facebook, Twitter, LinkedIn, Telegram, WhatsApp, forums, etc.',
  retentionQ6: '6. What makes Seabet.io different from other websites?',
  retentionA6:
    'Seabet.io has all the expectations you would have from most affiliate programs. What sets Seabet.io apart is our pioneering staff. We ensure the fastest service possible for our customers and affiliate customers, rewards, loyalty, and our multi-language and global service.',
  ...
  commissionA4: 'Your commissions may be affected when players you bring in win, as we deduct those winnings from revenue. However, this situation generally does not last long.',
  commissionQ5: '5. How often are commissions paid?',
  commissionA5:
    'Your affiliate commissions are automatically paid within the first 5 business days of each month. Funds will be added to your player account, and you can withdraw or use the commissions for betting on the website anytime.',
  commissionQ6: '6. Can I refer myself?',
  commissionA6: 'No, our affiliate program does not endorse this practice. It will be considered fraudulent behavior.',
  commissionQ7: '7. Does the affiliate program accept all websites?',
  commissionA7:
    'We do not promote ads for children or adult websites. We are against restrictive advertising; any member using such methods will be banned from our program, and we reserve the right to take legal action against any member who uses these websites to protect our site. Please refer to our rules and terms for more information.',
  report: 'Reports',
  memberManager: 'Member Management',
  commissionReport: 'Commission Report',
  financeReport: 'Financial Report',
  affiliateSupport: 'Support',
  advantageTitle: 'Advantages of SEABET.IO',
  advantageQ1: 'Detailed Statistics',
  advantageA1: 'Our unique affiliate system provides you with rapid updates and allows you to track your downline players, view player details, and link data.',
  advantageQ2: 'Lifetime Earnings',
  advantageA2:
    'As always, your potential earnings are unlimited, and the more traffic you bring, the more income you will receive. Our generous payment structure allows you to profit from each player.',
  advantageQ3: 'Fast Affiliate Payments',
  advantageA3: 'Fast affiliate payments. We pay commissions within the first 5 business days of each month.',
  advantageQ4: 'Leading Brand',
  advantageA4: 'We take pride in excellent service, and we are here to provide you with more ways to build a market-leading brand.',
  advantageQ5: 'Local Guidance',
  advantageA5: 'Benefit from guidance and assistance from our regional managers with over 10 years of experience in the gaming industry worldwide.',
  childMemberList: 'List of Downline Members',
  memberAccount: 'Member Account',
  statTime: 'Statistics Time',
  isBet: 'Is Bet',
  regTime: 'Registration Time',
  totalWinLose: 'Total Win/Loss',
  lastLoginTime: 'Last Login',
  bonus: 'Bonuses',
  refund: 'Refunds',
  venueFee: 'Venue Fees',
  depositFee: 'Deposit Fees',
  jingWinLose: 'Net Win/Loss',
  accountTz: 'Account Adjustments',
  manage: 'Management',
  dashboard: 'Dashboard',
  memberInfo: 'Member Information',
  memberRecord: 'Member Records',
  memberDeposit: 'Member Deposits',
  childMember: 'Downline Members',
  firshRecharge: 'First Deposit Count',
  newRegMonth: 'New Registrations This Month',
  newRegValid: 'Valid New Members',
  ...
  filter: 'Filter',
  agentDepositLimit: 'Agent Deposit Limit',
  canUseLimit: 'Available Limit',
  agentDepositRecord: 'Agent Deposit Records',
  yes: 'Yes',
  no: 'No',
  childAccount: 'Downline Account',
  inputChildAccount: 'Enter Downline Account',
  agentDepositAmount: 'Agent Deposit Amount',
  inputAgentDepositAmount: 'Enter Agent Deposit Amount',
  singleAgentDepositAmount: 'Single Agent Deposit Amount',
  agentDepositDayLimit: 'Daily Limit',
  withdrawFlowMult: 'Withdrawal Flow Multiplier',
  inputWithdrawFlowMult: 'Enter Withdrawal Flow Multiplier',
  multiple: 'Multiplier',
  remark: 'Remarks',
  ...
  monthDetailsData: 'Monthly Detailed Data',
  releaseTime: 'Release Time',
  activityUser: 'Active Users',
  netFee: 'Network Fees',
  ctfee: 'Deposit/Withdrawal Fees',
  lastMonthRemain: `Last Month's Balance`,
  infactCommission: 'Actual Commissions',
  today: 'Today',
  yestoday: 'Yesterday',
  ...
  winLoseTip:
    'Note: Positive numbers in total win/loss and net win/loss indicate company profits, while negative numbers indicate company losses. Daily data is for general reference only and is not the actual commission payout standard.',
  recommendLink: 'Referral Link',
  downloadBanner: 'Download Banners',
  childAccountNotExist: 'Downline account does not exist',
  depositAmountLimit: 'Agent deposit amount exceeds the single transaction limit',
  withdrawFlowMultLimit: 'Withdrawal flow multiplier exceeds the limit',
  agentDepositSuccess: 'Agent deposit successful',
  mustBeNumber: '{ tmp } must be a number',
  inputAccountStart: 'Enter member account to start searching',
  ...
  keepContact: 'Let’s keep in touch',
  subscribe: 'SUBSCRIBE',
  ...
  subscribeFail: '订阅失败',
  depositLimit: 'Recharge Limit',
  depositNewWindow: 'We are about to open a new window for your payment.',
  inputDepositAmount: 'Please enter the recharge amount.',
  depositAmountOver: 'The recharge amount cannot exceed the maximum limit.',
  depositAmountUnder: 'The recharge amount must not be less than the minimum limit.',
  providerInfo: 'Please, specify your personal details. All data is encrypted and secure.',
  fiatCpfHolder: 'Enter CPF',
  fiatName: 'Account Name',
  fiatNameHolder: 'Enter Name',
  fiatPixType: 'Bank Code',
  fiatPixTypeHolder: 'Select Bank Code',
  fiatPixAccount: 'Account',
  ...
  license: `<p><a>www.seabet.io</a> is operated by E Gambling Montenegro d.o.o. (Address: Podgorica, Moskovska Street 65, Reg. No.: 5-0615951) in cooperation with Open Sea Technology Limited(Address: Parham Town, Tortola, British Virgin Islands, P.O. Box 1110).</p></br>
            <p>E Gambling Montenegro d.o.o. (Address: Podgorica, Moskovska Street 65, Reg. No.: 5-0615951) hereby certifies that, under the concession <a>(serial no.: AA 001907, numeric no.: 142-03/12 4A and 1ER)</a> and approval <a>(no.: 03/01-121/3)</a>, it organizes and operates games of chance in Montenegro on the website <a>www.seabet.io.</a> This operation is based on the agreement concluded between E Gambling Montenegro d.o.o. and Open Sea Technology Limited(Address: Parham Town, Tortola, British Virgin Islands, P.O. Box 1110, Reg. No.: 1925170) on August 3, 2024.</p>`,
  ...
  vip: {
    ...
    vipWel: `<p>Welcome to the <b>Seabet</b> VIP Club</p>
              <p>At Seabet, we are committed to enhancing the quality of gaming and providing the best gaming experience. We have introduced a brand new VIP Club to reward our members who spend time playing games on our website faithfully.</p>
              <p>Simply place bets on any game or sports event provided by Seabet.io, and as you progress through the ranks, you will unlock exclusive rewards.</p>`,
    vipManage: `<dt>VIP Exclusive Manager</dt>
                <dd>Tailored for your needs</dd>
                <dd>Customized gaming experiences</dd>`,
    vipHighReward: ` <dt>High Rewards</dt>
                      <dd>No-wager bonuses</dd>
                      <dd>Rapid accumulation of points</dd>`,
    highLimit: `<dt>Customized Betting Experience</dt>
                <dd>Unlimited Transaction</dd>
                <dd>Higher max bet limits</dd>`,
    vipPromotion: `<dt>Exclusive VIP Promos</dt>
                    <dd>Custom offers</dd>
                    <dd>VIP-only access</dd>`,
    noQueue: `<dt>24/7 Top Service</dt>
              <dd>Quick multilingual support</dd>
              <dd>Personal account manager</dd>`,
    vipRewardDetailsTitle: 'VIP Reward Breakdown',
    vipRewardDetails: `<h2>VIP Reward Breakdown</h2>
                      <p>Level up to get exclusive access to generous rewards and personalized gifts! Join our community of elite players and enjoy the best that online gaming has to offer!</p>`,
    subTitle: {
      '102': 'Bronze 1',
      '103': 'Silver 1-5',
      '104': 'Gold 1-8',
    ...
    vipRewardDetailContent: `<dd>Subscription promotion email bonuses will be sent through the promotional email with a code. Use the code to redeem on the "Rewards" page.</dd>
                            ...
                            <dd>Weekly and monthly bonuses will be automatically added to the account within 48 hours after the start of the next week or month.</dd>
                            <dd>All bonus calculation periods will use Hong Kong Time, Hong Kong, China (UTC+8).</dd>`,
    howBeVipTitle: 'How to Become Our VIP Member',
    howBeVipContent: `<dd>
  ...
  faqs: {
    ...
    q2: 'How to withdraw crypto',
    a2: `<p>1. Choose the cryptocurrency you would like to withdraw, then click “Withdraw”.</p>
          <p>2. Enter the amount that you want to withdraw.</p>
          <p>3. Enter your wallet address.</p>
          <p>4. Click the Withdraw button.</p>`,
    q3: 'How long do deposits/withdrawals take?',
    a3: `<p>Deposit</p>
          <p>Most crypto deposits are processed at lightning speed. However, there may be some delays from third-party services.</p>
          <p>Withdrawal</p>
    ...
    q4: 'What payment methods do you offer?',
    a4: `<p>The available currency options in Seabet.io are:</p>
          <p>• Tether (USDT)</p>
          <p>• Bitcoin (BTC)</p>
          <p>• Ethereum (ETH)</p>
          <p>• Tron (TRX)</p>
  ...
  errorCodes: {
    1001: 'Record does not exist',
    1002: 'Activity is closed',
    1003: 'Data already exists',
    1004: 'Data error',
    1005: 'Parameter error',
    1006: 'You have not met the requirements for claiming',
    1007: 'You have already submitted this promotion application today',
    1008: 'Promotion has expired',
    1009: 'You have already claimed this promotion',
    1010: 'No qualifying deposit orders exist',
    1011: 'Deposit amount does not meet the requirements for claiming',
    1012: 'Google verification code is incorrect',
    1013: 'You still need to complete { data } USD in valid bets to make a withdrawal',
    1014: 'Username already exists',
    1015: 'Phone number already exists',
    1016: 'Email address already exists',
    1017: 'Incorrect username format',
    1018: 'Incorrect password format',
    1019: 'Incorrect verification code',
    1020: 'System is busy, please try again later',
    1021: 'Signature error',
    1022: 'Your account has been disabled, please contact customer service',
    1023: 'Incorrect username or password',
    1024: 'Account is locked',
    1025: 'Google Authenticator is already bound',
    1026: 'Google Authenticator is not bound',
    1027: 'Current password is incorrect',
    1028: 'Incorrect email address format',
    1029: 'Failed to send email',
    1030: 'Insufficient product quantity',
