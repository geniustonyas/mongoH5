export default {
  ...
  userName: 'ユーザー名',
  email: 'Eメール',
  sendEmail: '確認コードを送信する',
  sended: '送られた',
  emailCaptcha: '電子メール認証コード',
  password: 'パスワード',
  forgetPassword: '忘记密码',
  resetPwd: 'パスワードを再設定する',
  noUser: 'アカウントをお持ちではありませんか？',
  createUser: 'アカウントを作成する',
  googleCode: '谷歌身份验证码',
  inputGoole: 'Google認証コード入力してください',
  partner: 'オフィシャルパートナー：',
  date: '日にち',
  day: '日',
  month: '月',
  ...
  zipCode: '郵便番号',
  loginPage: {
    useGoogle: 'Google認証を使用する',
    userNameOrEmail: 'ユーザー名または、Eメール'
  },
  regPage: {
    holderUserName: 'お客さまのアカウント名',
    holderEmail: `例 :you{'@'}example.com`,
    holderTelephone: '電話',
    isAdult: '私は 18 歳以上であることを確認し、同意します',
    termCondition: '条款条件',
    privacyPolicy: '隐私政策',
    isAgree: 'Sportsbet.io からの独占ボーナスやキャンペーンメールの受信に同意します'
  },
  thirdRegPage: {
    beFinished: '快完成了哦！',
    fixInfo: '请补充完整您的资料'
  ...
  // vip俱乐部
  vipTitle: 'Seabet VIP Clubhouse',
  vipClub: 'VIP Clubhouse',
  // 账户设置
  ...
  androidApple: 'Android/IOSユーザー向け',
  globalPaymentSolutions: 'グローバル決済ソリューション',
  otherPayment: 'その他の主流の支払い方法',
  sportsBet: 'スポーツc賭け',
  liveCasinoBet: 'ライブカジノ賭け',
  slotBet: ' カジノ賭け',
  more: 'もっと',
  loadMore: 'もっと読み込む',
  providers: 'プロバイダー',
