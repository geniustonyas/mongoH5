...
export default {
  ...
  problem: {
    ...
    whatVips: `<p>${site_name} VIP Kulübü, kripto para müşterilerine açık olan, her zaman web sitesindeki tüm promosyon etkinliklerinin tadını çıkarmalarını sağlayan özel bir topluluktur. Oynadığınız her bahis, dönüş ve oyun puan biriktirecek, kulüpte yavaşça seviye atlayacak ve yol boyunca heyecan verici ödülleri kilitleyeceksiniz. VIP seviyelerini açtıkça, ayrıca Seabet bahis puanları kazanacaksınız, bu da size daha fazla ödüllendirici deneyimler ve hizmetler sunacaktır.</p>
  ...
  faqs: {
    ...
    a4: `<p>${site_name}'da mevcut olan para birimi seçenekleri:</p>
        <p>• Tether (USDT)</p>
        <p>• Bitcoin (BTC)</p>
        <p>• Ethereum (ETH)</p>
        <p>• Tron (TRX)</p>
    ...
    a5: `<p>${site_name}'daki yatırma ve çekme işlemleri için herhangi bir ücret almıyoruz, ancak blockchain ödemeleri kullanırken işlem ücretleri ödemeniz gerekebilir.</p>`
  },
  ...
  html: {
    ...
    rulesContent: `<div>
                    ...
                    <p><b>2.1 </b>BY REGISTERING ON WWW.${site_name} (THE “WEBSITE”), YOU ENTER INTO A CONTRACTED, AND AGREE TO BE BOUND BY: </p>
                    ...
                    <h3>3. GENERAL</h3>
                    <p><b>3.1 </b>When registering on www.${site_name}.</p>
