...
export default {
  ...
  newPwd: '새비밀번호',
  confirmPwd: '비밀번호재확인',
  changePwdLimit: '자금의 안전을 위해서, 비밀번호 수정후 48시간동안 출금을 진행 할수 없습니다.',
  ...
  tips: {
    ...
    isAudit: '당신은 성년이며 당사의 개인정보정책에 동의 했다는것에 대해 확인 부탁드립니다.',
    isAgree: '시장활동 관련된 정보를 읽고 동의해 주세요.',
    regSuccess: '등록성공',
    regFail: '등록실패',
    loginSuccess: '로그인성공',
    sendSuccess: '발송성공',
  ...
  html: {
    ...
    rulesContent: `<div>
                    ...
                    <p><b>5.2 </b><b>5.1에</b>  언급된 진술, 영장 또는 계약을 위반하는 경우 Seabet은 자체 재량에 따라 귀하의 Seabet 계정을 폐쇄 또는 정지하고 법률이 적용되는 범위 내에서 모든 베팅을 무효화할 수 있는 권리를 보유합니다.</p>
                    ...
                    <p>(iii) Seabet이 전체 정산 금액에 대해 배팅이 현금화되거나 배팅이 잘못 무효가 된 경우, 배팅 시 '플레이어가 시작하지 않으면 무효'가 선택된 경우를 포함하여 정산 금액을 잘못 계산하거나 지불한 경우; 또는 </p>
                    <p>(iv) 게임이나 제품에 포함, 통합 또는 사용되는 난수 생성기 또는 지불 테이블에서 오류가 발생합니다.</p>
