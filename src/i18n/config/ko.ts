export default {
  ...
  retentionA1:
    'Seabet.io 제휴 프로그램은 당신과 운영자 간의 협력 관계로, 당신의 웹사이트, 소셜 미디어, 포럼, 링크 등을 통해 보내는 잠재적인 고객에 대한 수수료를 지불합니다. 매출을 생성하는 각 추천 활성 고객은 당신에게 수익을 창출합니다.',
  retentionQ2: '2. 제휴 프로그램에 가입하려면 어떻게 해야 하나요?',
  retentionA2: `등록은 필요하지 않습니다. 모든 성공적으로 등록된 회원은 독점적인 링크를 가지게 됩니다. 보려면 메뉴 바의 '제휴 프로그램'을 클릭하십시오.`,
  ...
  commissionQ4: '4. 음의 잔액이 다음 달로 이월됩니까?',
