export default {
  ...
  regPage: {
    ...
    isAgree: `나는 SEABET 의 프로모션 활동 관련한 시장정보를 받는 것에 동의 합니다`
  },
  thirdRegPage: {
    beFinished: '곧 완성됩니다!',
  ...
  unlockNewReward: ' 새로운 보너스가 나왔습니다!',
  ...
  receivedSuccess: '{ amount } { currency }성공적으로 수령',
  goTime: '출발 시간',
  backTime: '돌아오는 시간',
  inTime: '호텔 체크인 시간',
  outTime: '호텔 체크아웃 시간',
  ...
  affiliateTitle: '글로벌 제휴 프로그램',
  overview: '개요',
  advantage: '장점',
  affiliateQuestion: '자주 묻는 질문',
  overviewDesc: `SEABET.IO는 최고의 암호화폐 기반 베팅 플랫폼입니다. 우리는 라이브 스포츠, 라이브 카지노 및 슬롯 베팅 게임에 관심 있는 플레이어들을 위한 공정하고 안전한 플랫폼을 제공하며, 세계적인 제공업체가 개발한 42만 건 이상의 프리매치 이벤트 및 수천 가지 다른 비디오 슬롯, 게임 테이블 및 라이브 딜러 게임을 제공합니다. SEABET.IO는 기록적인 성장을 이루어왔으며, 당신도 우리 성공 스토리의 일부가 되실 것을 정중히 요청드립니다..`,
  bePartner: '파트너가 되기',
  howBePartner: 'SEABET.IO를 홍보하고 할당량한도 없이 최대 50% 수익을 올리세요! 우리는 세계 각지의 다른 지역 관리자를 대상으로 11개 언어로 서비스를 제공합니다!',
  commissionDetails: '커미션 상세정보:',
  level: '레벨',
  ...
  generalInfo: '일반 정보',
  retentionQ1: '1. 제휴 프로그램이란 무엇인가요?',
  retentionA1:
    'Seabet.io 제휴 프로그램은 당신과 운영사 간의 협력 관계로,  당신의 웹사이트, 소셜 미디어, 포럼, 링크 등을 통해 보내오는 잠재적인 고객에 대한 커미션을 지불합니다.  매출을 형성시키는 각각의 활성 고객은 당신에게 수익을 창출 할 것입니다.',
  retentionQ2: '2. 제휴 프로그램에 가입하려면 어떻게 해야 하나요?',
  retentionA2: `별도의 등록은 필요하지 않습니다.  모든 SEABET.IO에 성공적으로 등록된 회원은 독점적인 링크를 가지게 됩니다.  보시려면 메뉴바의 '제휴 프로그램'을 클릭 하십시오.`,
  retentionQ3: '3. 제휴 프로그램을 통해 얼마나 수익을 올릴 수 있나요?',
  retentionA3: '수익을 올릴 수 있는 한도가 없습니다. 더 많은 고객을 유입시키면 수익을 늘릴 가능성이 커집니다.',
  retentionQ4: '4. 제휴가 되려면 비용이 드나요?',
  retentionA4: 'Seabet.io 제휴 프로그램은 완전히 무료입니다! 우리의 목표는 당신이 우리 브랜드를 홍보하는 데 도움을 주는 것이며, 당신의 노력에 보상을 하기를 희망합니다.',
  retentionQ5: '5. 홍보를 시작하려면 어떻게 하나요?',
  retentionA5: '웹사이트가 없어도 Facebook, Twitter, LinkedIn, Telegram, WhatsApp, 포럼 등과 같은 다양한 채널을 통해 효과적으로 홍보할 수 있습니다.',
  retentionQ6: '6. Seabet.io를 다른 웹사이트와 구분 짓는 요소는 무엇인가요?',
  retentionA6:
    'Seabet.io는 대부분의 제휴 프로그램에서 기대하는 것을 갖추고 있습니다. Seabet.io를 다른 웹사이트와 구분 짓는 것은 우리의 개척적인 스태프입니다. 우리는 고객과 제휴 고객에게 가능한 빠른 서비스, 보상, 충성도, 그리고 다국어 및 글로벌 서비스를 보장합니다.',
  commission: '수수료',
  commissionQ1: '1. 어떻게 수수료를 벌 수 있나요?',
  commissionA1: '플레이어를 추천할 때, 해당 플레이어가 당신의 제휴 계정에 링크됩니다. 당신의 플레이어가 실제 머니 게임을 플레이하여 수익을 생성할 때, 당신은 그 수익의 특정 비율을 받게 됩니다.',
  commissionQ2: '2. 제휴 수익을 정확하게 계산하는 방법?',
  commissionA2: '사용자가 웹 사이트에서 베팅을 할 때마다 해당 사용자의 수익의 일정 백분율을 받게됩니다. 수익 = (게임 내 총 승/패 – 보너스 – 네트워크 수수료 – 입출금 수수료) x (귀하의 수수료 비율).',
  commissionQ2Desc: '● 네트워크 수수료 = 게임 내 총 승/패 × 10%',
  commissionQ3: '3. 어떻게 성과를 추적할 수 있나요?',
  commissionA3: '제휴 대시보드에 로그인하여 성과를 추적할 수 있습니다. 메인 페이지에서 모든 관련 정보를 찾을 수 있습니다. 더 깊은 분석을 위해 플레이어 세부 정보와 추적 데이터를 제공합니다.',
  commissionQ4: '4. 마이너스 잔액은 다음 달로 이월 됩니까?',
  commissionA4: '당신이 유입시킨 플레이어가 이기면 수익에서 그 승리 금액을 차감하므로 당신의 수수료에 영향을 미칠 수 있습니다. 그러나 이러한 상황은 일반적으로 오래 지속되지 않습니다.',
  commissionQ5: '5. 수수료는 얼마나 자주 지급되나요?',
  commissionA5: '제휴 커미션은 매월 첫 5 영업일 이내에 자동으로 지급됩니다.  커미션은 당신의 플레이어 계정에 추가 되며,  언제든지 웹사이트에서 인출하거나 베팅에 사용할 수 있습니다.',
  commissionQ6: '6. 나 자신을 플레이어로 추천할 수 있나요?',
  commissionA6: '아니요,  저희 제휴 프로그램은 이러한 방법을 인정하지 않습니다.  이것은 부정한 행위로 간주될 것입니다.',
  commissionQ7: '7. 제휴 프로그램은 모든 웹사이트를 허용하나요?',
  commissionA7:
    '아동 또는 성인 웹사이트의 광고를 지지하지 않습니다. 제한적인 광고에 반대하며, 이러한 방법을 사용하는 회원은 프로그램에서 제제될 것이며, 당사 사이트를 보호하기 위해 이러한 웹사이트를 사용하는 회원에 대해 법적 조치를 취할 권리를 보유합니다. 자세한 정보는 규칙과 약관을 참조하십시오.',
  report: '리포트',
  memberManager: '회원 관리',
  commissionReport: '수수료 리포트',
  financeReport: '재무 리포트',
  affiliateSupport: '지원',
  advantageTitle: 'SEABET.IO의 장점',
  advantageQ1: '자세한 통계',
  advantageA1: '우리의 독특한 제휴 시스템은 신속한 업데이트를 제공하며 다운라인 플레이어를 추적하고 플레이어 세부 정보 및 링크 데이터를 볼 수 있습니다.',
  advantageQ2: '평생 수익',
  advantageA2:
    '늘 그렇듯이 당신의 잠재적인 수익은 무제한이며, 당신이 유입시키는 트래픽이 많을수록 더 많은 수익을 얻을 수 있습니다. 당사의 관대한 지불 구조는 당신이 각 플레이어에서 이익을 얻을 수 있도록 합니다.',
  advantageQ3: '신속한 커미션 지불',
  advantageA3: '제휴사에 대한 커미션 지불은 신속하게 진행 됩니다.  당사는 매월 첫 5영업일 이내에 지불합니다.',
  advantageQ4: '주요 브랜드',
  advantageA4: '우리는 훌륭한 서비스에 자부심을 가지며 시장을 선도하는 브랜드를 구축하는 더 많은 방법을 제공하려고 노력하고 있습니다.',
  advantageQ5: '현지 안내',
  advantageA5: '게임 업계에서 10년 이상의 경험을 가진 지역 관리자들로부터의 안내와 지원을 받을 수 있습니다.',
  childMemberList: '다운라인 회원 목록',
  memberAccount: '회원 계정',
  statTime: '통계 시간',
  isBet: '베팅 여부',
  regTime: '등록 시간',
  ...
  memberDeposit: '회원 입금',
  childMember: '다운라인 회원',
  firshRecharge: '첫 입금 수',
  newRegMonth: '이번 달 새로운 등록',
  newRegValid: '유효한 새 회원',
  ...
  filter: '필터',
  agentDepositLimit: '에이전트 입금 한도',
  canUseLimit: '사용 가능한 한도',
  agentDepositRecord: '에이전트 입금 기록',
  yes: '예',
  no: '아니요',
  childAccount: '다운라인 계정',
  inputChildAccount: '하부 계정 입력',
  agentDepositAmount: '에이전트 입금 금액',
  inputAgentDepositAmount: '입금 금액 입력',
  singleAgentDepositAmount: '단일 에이전트 입금 금액',
  agentDepositDayLimit: '일일 한도',
  withdrawFlowMult: '인출 플로우 배수',
  inputWithdrawFlowMult: '인출 플로우 배수 입력',
  multiple: '배수',
  remark: '비고',
  inputRemark: '비고 입력',
  loginPwd: '로그인 비밀번호',
  inputLoginPwd: '로그인 비밀번호 입력',
  optime: '작업 시간',
  agentDepositStatus: {
    0: '실패',
    1: '성공'
  },
  monthDetailsData: '월간 상세 데이터',
  releaseTime: '발표 시간',
  activityUser: '활성 사용자',
  netFee: '네트워크 수수료',
  ctfee: '입금/출금 수수료',
  lastMonthRemain: '지난 달 잔고',
  infactCommission: '실제 수수료',
  today: '오늘',
  yestoday: '어제',
  currentWeek: '현재 주',
  laskWeek: '지난 주',
  currentMonth: '현재 달',
  depositDetails: '입금 세부정보',
  withdrawDetails: '출금 세부정보',
  rewardDetails: '보상 세부정보',
  winLoseTip: '참고: 총 승패 및 순 수익/손실의 양수는 회사 이익을 나타내며, 음수는 회사 손실을 나타냅니다. 일일 데이터는 참고용이며 실제 수수료 지급 기준이 아닙니다.',
  recommendLink: '추천 링크',
  downloadBanner: '베너 다운로드',
  childAccountNotExist: '하부 계정이 존재하지 않습니다',
  depositAmountLimit: '에이전트 입금 금액이 단일 거래 한도를 초과합니다',
  withdrawFlowMultLimit: '출금 플로우 배수가 한도를 초과합니다',
  agentDepositSuccess: '에이전트 입금 성공',
  mustBeNumber: '{ tmp }은(는) 숫자여야 합니다',
  inputAccountStart: '회원 계정을 검색하려면 입력하세요',
  ...
  financeRewards: '보너스',
  emailAddress: '이메일 주소',
  keepContact: '연락을 지속합시다',
  subscribe: '구독하기',
  subscribeEmail: '이메일 구독',
  ...
  vip: {
    ...
    vipWel: `<p>Seabet VIP 클럽에 오신 것을 환영합니다</p>
    ...
    vipManage: `<dt>VIP 전용 관리자</dt>
                <dd>맞춤형 니즈</dd>
                <dd>맞춤 게임 경험</dd>`,
    vipHighReward: ` <dt>고액 보상</dt>
                      <dd>베팅 없는 보너스</dd>
                      <dd>빠른 포인트 축적</dd>`,
    highLimit: `<dt>맞춤형 베팅 경험</dt>
                <dd>무제한 거래</dd>
                <dd>높은 최대 베팅 한도</dd>`,
    vipPromotion: `<dt>VIP 전용 프로모션</dt>
                    <dd>맞춤형 제안</dd>
                    <dd>VIP 전용 액세스</dd>`,
    noQueue: `<dt>24/7 최고 서비스</dt>
              <dd>빠른 다국어 지원</dd>
              <dd>개인 계정 관리자</dd>`,
    vipRewardDetailsTitle: 'VIP 보상 내역',
    vipRewardDetails: `<h2>VIP 보상 내역</h2>
                      <p>넉넉한 보상과 맞춤형 선물을 독점적으로 받으려면 레벨을 올리십시오!</p>`,
    subTitle: {
      '102': '브론즈 1',
      '103': '실버 1-5',
      '104': '골드 1-8',
    ...
    vipRewardDetailContent: `<dd>프로모션 이메일 구독 보너스는 코드가 포함된 프로모션 이메일을 통해 전송됩니다. 코드를 사용하여 "보상" 페이지에서 교환할 수 있습니다.</dd>
                            ...
                            <dd>주간 및 월간 보너스는 다음 주나 다음 달이 시작된 후 48시간 이내에 자동으로 계정에 추가됩니다.</dd>
                            <dd>모든 보너스 계산 기간은 홍콩 시간, 중국 홍콩 (UTC+8)을 사용합니다.</dd>`,
    howBeVipTitle: 'VIP 회원이 되는 방법',
    howBeVipContent: `<dd>지속적인 베팅: VIP가 되는 핵심은 다양한 스포츠 이벤트와 카지노 게임에 지속적으로 베팅하는 것입니다. Seabet은 귀하의 일관성에 대해 보상합니다. 최고의 암호화폐 게임 웹사이트로서 Seabet이 제공하는 이벤트와 카지노 게임에 대한 베팅에 정기적으로 디지털 자산을 사용하십시오. 또한 USDT로 베팅을 시도하고 자금을 지속적으로 사용하시면 됩니다.</dd>
                      <dd>정기적인 이벤트 참여: Seabet의 프로모션 이벤트에는 언제든지 참여할 수 있는 다양한 활동과 토너먼트대회가 포함되어 있습니다. 이러한 활동에 정기적으로 참여하면 VIP 클럽 초대장을 받을 기회가 증가하며, Seabet의 다른 클럽에서도 더 활발하게 활동할 수 있습니다</dd>
                      ...
                      <dd>Seabet VIP로서 품격 높은 경험 하기: Seabet VIP 클럽 회원으로서의 특전을 즐기면서 USDT 게임의 즐거움을 새로운 차원으로 끌어올릴 수 있습니다. 스포츠 베팅과 카지노 게임에 참여할 때 VIP 플레이어로서 즐겁고, 신속하고 공정한 베팅을 즐길 수 있습니다.</dd>`
  },
  ...
  problem: {
    ...
    whyMergedRewards: `<p>보너스가 합쳐진 이유는 한번의 베팅으로 여러 보너스를 한번에 언락할 수 있기 때문입니다.  편의를 위해,  가치를 합쳐져 하나의 보너스로 표시됩니다.</p>`,
    resetVip: '6.내 VIP 레벨은 언제 초기화되나요?',
    resetVips: `<p>회원님의 VIP 레벨은 매월 초에 0으로 초기화됩니다. 그런 다음 브론즈 레벨부터 다시 시작하고 다음 레벨의 모든 보너스를 요구할 수 있습니다. 누적된 포인트는 여전히 보너스와 서비스를 더 많이 교환할 수 있도록 보존됩니다.</p>`,
    everyGetInterial: '6.모든 베팅으로 클럽 포인트를 얻을 수 있나요?',
  ...
  errorCodes: {
    ...
    1035: '게임 유지 보수 중',
    1037: '귀하의 계정이 비활성화되었습니다',
    1038: '하위 회원이 존재하지 않습니다.',
  ...
  html: {
    ...
    fairnessContent: `<div>
                        ...
                        <p><b>11.22 </b>다음은 인출 기능과 관련이 있습니다.</p>

                        <p><b>11.22.1 </b>출금은 경기 전과 경기 중 선택된 이벤트, 경기 및 시장, 단일 및 다중 베팅에 대해 가능합니다. </p>

                        <p><b>11.22.2 </b>출금 요청 수락 지연. 가격 또는 시장 변동이 일시 중지되면 출금 요청이 성공하지 못할 수 있습니다. </p>

                        <p><b>11.22.3 </b>출금 요청이 승인되면 해당 베팅이 즉시 표시되고 정산됩니다. 원래 베팅의 실제 최종 결과는 인출 프로세스에 영향을 미치지 않습니다.</p>

                        <p><b>11.22.4 </b>어떠한 경우에도 출금 요청이 성공하면 총 환불 금액이 귀하의 계정으로 반환됩니다. </p>

                        <p><b>11.22.5 </b>웹사이트는 귀하의 베팅이 출금 옵션에 사용할 수 있다고 보장할 수 없습니다. 이벤트 전에 철회가 이루어진 경우, 당사는 라이브 이벤트에 대한 커버리지를 적용하거나 중단하지 않으며, 이벤트가 시작되거나 라이브 매치가 중단된 후에는 철회할 수 없습니다. 시장이 일시 중지되면 지불금이 제공되지 않습니다. </p>

                        <p><b>11.22.6 </b>이 웹사이트는 고객 또는 고객 그룹의 기능적 매각을 완전히 또는 부분적으로 철회할 수 있는 권리를 보유합니다. 당사는 고객 또는 고객 그룹이 이벤트 전 가격 변동을 이용하기 위해 출금 기능을 남용하고 있거나 이벤트 시작 전에 베팅을 마감하기 위해 출금 기능을 정기적으로 사용하고 있다는 합리적인 의심이 있는 경우 이 권리를 행사합니다. </p>

                        <p><b>11.22.7 </b>기술적인 이유로 출금 기능을 사용할 수 없는 경우 이 웹사이트는 이에 대해 책임을 지지 않습니다. 또한 이러한 경우의 모든 베팅은 원래 베팅 상태를 유지하며 이 웹사이트도 책임을 지지 않습니다. 。 </p>

                        <p><b>11.22.8 </b>웹사이트는 현금 인출 기능에 포함된 스포츠, 대회, 시장 또는 베팅 유형을 현금화하기 위한 모든 베팅/베팅을 수락하거나 거부할 권리가 있습니다. </p>

                        <p><b>11.23 </b>최대 상금은 세계를 확보하기 위한 기본 통화로 USD로 표시되지만 실제 지출에는 이에 상응하는 통화가 적용됩니다. 여러 베팅에 최대 보너스 한도가 다른 이벤트가 포함되는 경우 최소 금액이 적용됩니다. 두 가지 최대 보너스 한도는 동일한 선택의 베팅을 다른 가격으로 포함하기 위해 다른 베팅 계정을 사용하는 모든 고객 또는 고객 그룹에 적용됩니다. 이러한 방식으로 여러 베팅이 이루어졌다고 믿을 만한 이유가 있어야 하며 이러한 베팅의 전체 지불은 최대 지불금이 하나만 합산됩니다. </p>
