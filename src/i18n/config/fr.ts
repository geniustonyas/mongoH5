export default {
  ...
  commissionQ2: `2. Comment calculer avec précision mes bénéfices d'affilié ?`,
  commissionA2: `À chaque fois qu'un joueur mise sur notre site web, vous recevrez un certain pourcentage du revenu de ce joueur. Votre profit = (gain/perte totale en jeu - bonus - 15 % de frais réseau - frais de dépôt/retrait) x (votre pourcentage de commission).`,
  commissionQ2Desc: '● Frais réseau = 15 % du gain/perte totale en jeu',
  ...
  agentDepositRecord: `Dossiers de dépôt de l'agent`,
  yes: 'Oui',
  no: 'Non',
  ...
  inputWithdrawFlowMult: 'Entrez le coefficient de flux de retrait',
