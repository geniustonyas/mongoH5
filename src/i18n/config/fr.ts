export default {
  ...
  regPage: {
    ...
    isAgree: `J'accepte de recevoir des informations commerciales et des promotions de SEABET.`
  },
  thirdRegPage: {
  ...
  gameStatic: 'Statistiques du jeu',
  receivedSuccess: '{ amount } USDT Réclamé',
  receivedSuccess2: '{ amount } { currency } Réclamé',
  ...
  affiliateTitle: `Programme d'affiliation mondial`,
  overview: 'Aperçu',
  advantage: 'Avantages',
  affiliateQuestion: 'Questions fréquemment posées',
  overviewDesc: `SEABET.IO est la meilleure plateforme de paris basée sur la cryptomonnaie. Nous fournissons une plateforme équitable, sécurisée et inclusive pour les joueurs intéressés par les paris en direct sur le sport, les casinos en direct et les jeux de paris sur les machines à sous, offrant plus de 420 000 événements pré-match et des milliers de machines à sous vidéo différentes, de tables de jeu et de jeux de croupiers en direct développés par des fournisseurs de renommée mondiale. SEABET.IO a connu une croissance record, et nous vous invitons à faire partie de notre histoire à succès.`,
  bePartner: 'Devenez partenaire',
  howBePartner: `Promouvez SEABET.IO et gagnez jusqu'à 50 % de part de revenus sans quota ! Nous proposons des services dans 11 langues avec des responsables régionaux dédiés ciblant différentes parties du monde !`,
  commissionDetails: 'Détails de la commission :',
  level: 'Niveau',
  monthActivePlayer: 'Joueurs actifs mensuels',
  commissionRate: 'Taux de commission',
  activePlayerDesc: `Joueurs Actifs : Dépôts mensuels ≥ 100 USDT ou mises mensuelles ≥ 500 USDT (ou équivalent dans d'autres devises virtuelles)`,
  retentionTitle: 'Questions et réponses',
  retentionSubTitle: 'Des questions ? Consultez ici.',
  ...
  retentionA4: `Le programme d'affiliation Seabet.io est entièrement gratuit ! Notre objectif est de vous aider à promouvoir notre marque, et nous sommes heureux de récompenser vos efforts.`,
  retentionQ5: `5. Comment puis-je commencer à promouvoir ?`,
  retentionA5: `Vous pouvez promouvoir efficacement à travers divers canaux sans avoir votre site web, tels que Facebook, Twitter, LinkedIn, Telegram, WhatsApp, des forums, etc.`,
  retentionQ6: `6. Qu'est-ce qui distingue Seabet.io des autres sites web ?`,
  retentionA6: `Seabet.io répond à toutes les attentes que vous auriez de la plupart des programmes d'affiliation. Ce qui distingue Seabet.io, ce sont nos employés novateurs. Nous nous assurons de fournir le service le plus rapide possible à nos clients et aux clients affiliés, des récompenses, de la fidélité et notre service multilingue et mondial.`,
  commission: 'Commission',
  commissionQ1: '1. Comment gagne-t-on des commissions ?',
  commissionA1: `Lorsque vous recommandez un joueur, ce joueur est lié à votre compte d'affilié. Vous recevrez un pourcentage du revenu lorsque vos joueurs génèrent des revenus grâce à des jeux en argent réel.`,
  commissionQ2: `2. Comment calculer précisément mes profits d'affiliation ?`,
  commissionA2: `Chaque fois qu'un joueur place un pari sur notre site Web, vous recevrez un pourcentage de ces revenus. Votre profit = (Gain/perte total dans le jeu – Bonus – Frais réseau – Frais de dépôt/retrait) x (Votre pourcentage de commission).`,
  commissionQ2Desc: '● Frais réseau = Gain/perte total dans le jeu × 10%',
  commissionQ3: '3. Comment puis-je suivre mes performances ?',
  commissionA3: `Vous pouvez suivre vos performances en vous connectant au tableau de bord d'affilié. Sur la page principale, vous trouverez toutes les informations pertinentes. Pour une analyse plus approfondie, nous fournissons divers détails sur les joueurs et vos données de suivi.`,
  commissionQ4: '4. Les soldes négatifs sont-ils reportés au mois suivant ?',
  commissionA4:
    'Vos commissions peuvent être affectées lorsque les joueurs que vous avez recommandés gagnent, car nous déduisons ces gains des revenus. Cependant, cette situation ne dure généralement pas longtemps.',
  commissionQ5: '5. À quelle fréquence les commissions sont-elles payées ?',
  commissionA5: `Vos commissions d'affilié sont automatiquement payées dans les 5 premiers jours ouvrables de chaque mois. Les fonds seront ajoutés à votre compte joueur, et vous pourrez les retirer ou les utiliser pour parier sur le site web à tout moment.`,
  commissionQ6: '6. Puis-je me recommander moi-même ?',
  commissionA6: `Non, notre programme d'affiliation ne soutient pas cette pratique. Elle sera considérée comme un comportement frauduleux.`,
  commissionQ7: `7. Le programme d'affiliation accepte-t-il tous les sites web ?`,
  commissionA7: `Nous ne faisons pas la promotion d'annonces pour les sites web pour enfants ou pour adultes. Nous sommes contre la publicité restrictive ; tout membre utilisant de telles méthodes sera banni de notre programme, et nous nous réservons le droit d'engager des poursuites judiciaires contre tout membre qui utilise ces sites web pour protéger notre site. Veuillez vous référer à nos règles et conditions pour plus d'informations.`,
  report: 'Rapports',
  memberManager: 'Gestion des membres',
  commissionReport: 'Rapport de commission',
  financeReport: 'Rapport financier',
  affiliateSupport: 'Support',
  advantageTitle: 'Avantages de SEABET.IO',
  advantageQ1: 'Statistiques détaillées',
  advantageA1: `Notre système d'affiliation unique vous fournit des mises à jour rapides et vous permet de suivre vos joueurs de niveau inférieur, de consulter les détails des joueurs et les données de suivi.`,
  advantageQ2: 'Revenus à vie',
  advantageA2:
    'Comme toujours, vos revenus potentiels sont illimités, et plus vous apportez de trafic, plus vous recevrez de revenus. Notre structure de paiement généreuse vous permet de tirer profit de chaque joueur.',
  advantageQ3: `Paiements d'affiliés rapides`,
  advantageA3: `Paiements d'affiliés rapides. Nous payons les commissions dans les 5 premiers jours ouvrables de chaque mois.`,
  advantageQ4: 'Marque de premier plan',
  advantageA4: 'Nous sommes fiers de fournir un excellent service, et nous sommes là pour vous offrir plus de moyens de construire une marque leader sur le marché.',
  advantageQ5: 'Conseils locaux',
  advantageA5: `Bénéficiez de conseils et d'assistance de nos responsables régionaux ayant plus de 10 ans d'expérience dans l'industrie du jeu dans le monde entier.`,
  childMemberList: 'Liste des membres de niveau inférieur',
  memberAccount: 'Compte membre',
  statTime: 'Heure des statistiques',
  isBet: 'Mise',
  regTime: `Heure d'inscription`,
  totalWinLose: 'Gain/perte totale',
  lastLoginTime: 'Dernière connexion',
  bonus: 'Bonus',
  refund: 'Remboursements',
  venueFee: 'Frais de salle',
  depositFee: 'Frais de dépôt',
  jingWinLose: 'Gain/perte nette',
  accountTz: 'Ajustements de compte',
  manage: 'Gestion',
  dashboard: 'Tableau de bord',
  memberInfo: 'Informations sur les membres',
  memberRecord: 'Dossiers des membres',
  memberDeposit: 'Dépôts des membres',
  childMember: 'Membres de niveau inférieur',
  firshRecharge: 'Nombre de premiers dépôts',
  newRegMonth: 'Nouvelles inscriptions ce mois-ci',
  newRegValid: 'Nouveaux membres valides',
  activityMemberMonth: 'Membres actifs ce mois-ci',
  winLoseMonth: 'Gain/perte nette ce mois-ci',
  dataCompare: 'Comparaison des données',
  dashAmount: 'Montant',
  peopleCount: 'Personnes',
  regCount: `Nombre d'inscriptions`,
  firshRechargeCount: 'Nombre de premiers dépôts',
  filter: 'Filtre',
  agentDepositLimit: `Limite de dépôt de l'agent`,
  canUseLimit: 'Limite disponible',
  agentDepositRecord: `Dossiers d'agent`,
  yes: 'Oui',
  no: 'Non',
  childAccount: 'Compte de niveau inférieur',
  inputChildAccount: 'Entrez le compte de niveau inférieur',
  agentDepositAmount: `Montant du dépôt de l'agent`,
  inputAgentDepositAmount: `Entrez le montant du dépôt de l'agent`,
  singleAgentDepositAmount: `Montant unique de dépôt de l'agent`,
  agentDepositDayLimit: 'Limite quotidienne',
  withdrawFlowMult: 'Coefficient de flux de retrait',
  inputWithdrawFlowMult: 'Entrer le multiplicateur de retrait',
  multiple: 'Multiplicateur',
  remark: 'Remarques',
  inputRemark: 'Entrez des remarques',
  loginPwd: 'Mot de passe de connexion',
  inputLoginPwd: 'Entrez le mot de passe de connexion',
  optime: `Heure de l'opération`,
  agentDepositStatus: {
    0: 'Échec',
    1: 'Réussi'
  },
  monthDetailsData: 'Données mensuelles détaillées',
  releaseTime: 'Heure de sortie',
  activityUser: 'Utilisateurs actifs',
  netFee: 'Frais de réseau',
  ctfee: 'Frais de dépôt/retrait',
  lastMonthRemain: 'Solde du mois dernier',
  infactCommission: 'Commissions réelles',
  today: `Aujourd'hui`,
  yestoday: 'Hier',
  ...
  winLoseTip: `Remarque : Les nombres positifs dans le gain/perte totale et la gain/perte nette indiquent les profits de l'entreprise, tandis que les nombres négatifs indiquent les pertes de l'entreprise. Les données quotidiennes sont à titre de référence générale seulement et ne correspondent pas aux normes réelles de paiement des commissions.`,
  recommendLink: 'Lien de parrainage',
  downloadBanner: 'Télécharger des bannières',
  childAccountNotExist: `Le compte de niveau inférieur n'existe pas`,
  depositAmountLimit: `Le montant du dépôt de l'agent dépasse la limite de transaction unique`,
  withdrawFlowMultLimit: `Le coefficient de flux de retrait dépasse la limite`,
  agentDepositSuccess: `Dépôt de l'agent réussi`,
  mustBeNumber: '{ tmp } doit être un nombre',
  inputAccountStart: 'Entrez le compte de membre pour commencer la recherche',
  ...
  selRemark: 'Sélectionner une remarque',
  remarkContent: { 1: 'Récompenses de Bienvenue', 2: 'Bonus de Retour', 3: 'Récompenses de Chance', 4: 'Bonus de Bonne Chance', 5: 'Récompenses de Fidélité' },
  finishCaptcha: 'Veuillez terminer la vérification humaine.',
  captchaVerifyFail: 'La vérification humaine a échoué, veuillez réessayer.',
  ...
  depositNewWindow: `Nous sommes sur le point d'ouvrir une nouvelle fenêtre pour votre paiement.`,
  inputDepositAmount: 'Veuillez saisir le montant de la recharge.',
  depositAmountOver: 'Le montant de la recharge ne peut pas dépasser la limite maximale.',
  depositAmountUnder: 'Le montant de la recharge ne doit pas être inférieur à la limite minimale.',
  ...
  fundCurrency: 'Devise',
  gameProviders: 'Fournisseurs',
  mostPopular: 'Jeux les mieux notés',
  viewAll: 'Voir Tout',
  accountType: 'Type de Compte',
  bankCode: 'Code Bancaire',
  bankAccountNo: 'Numéro de Compte',
  bankAccountName: 'Nom du Titulaire du Compte',
  ifsc: 'IFSC',
  bankCodeHolder: 'Sélectionner le Code Bancaire',
  bankAccountNoHolder: 'Entrer le Numéro de Compte Bancaire',
  bankAccountNameHolder: 'Entrer le Nom du Titulaire du Compte Bancaire',
  ifscHolder: 'Entrer le IFSC',
  indexSlots: 'SLOTS',
  indexCasino: 'LIVE CASINO',
  blog: 'Blog',
  otherHoArticle: 'Autres Articles Populaires',
  seabetGame: 'Originaux',
  bankScanQr: 'Scan QR de la Banque',
  bankTransfer: 'Virement Bancaire',
  sameAs: ' Équivalent à',
  bankList: 'Banque',
  rechargeType: 'Méthode de recharge',
  exhange: 'Conversion',
  license: `<p><a>www.seabet.io</a> est exploité par E Gambling Montenegro d.o.o. (Adresse : Podgorica, Rue Moskovska 65, Reg. No. : 5-0615951) en coopération avec Open Sea Technology Limited(Adresse : Parham Town, Tortola, Îles Vierges britanniques, Boîte Postale 1110).</p></br>
            <p>E Gambling Montenegro d.o.o. (Adresse : Podgorica, Rue Moskovska 65, Reg. No. : 5-0615951) certifie par la présente que, sous la concession <a>(numéro de série : AA 001907, numéro numérique : 142-03/12 4A et 1ER)</a> et l'approbation <a>(n° : 03/01-121/3)</a>, elle organise et opère des jeux de hasard au Monténégro sur le site <a>www.seabet.io</a>. Cette opération est basée sur l'accord conclu entre E Gambling Montenegro d.o.o. et Open Sea Technology Limited(Adresse : Parham Town, Tortola, Îles Vierges britanniques, Boîte Postale 1110, Reg. No. : 1925170) le 3 août 2024.</p>`,
