...
export default {
  ...
  step: 'Paso',
  clickSave: 'En el navegador, haz clic en el ícono de guardar',
  addDesk: 'Toca "Agregar a la pantalla de inicio"',
  clickAdd: 'Tendrás la opción de renombrarlo. Haz clic en "Agregar"',
