export default {
  ...
  advantage: 'Ventajas',
  affiliateQuestion: 'Preguntas Frecuentes de Afiliados',
  overviewDesc:
  ...
  filter: 'Filtrar',
  agentDepositLimit: 'Límite de Depósito de Agente',
  canUseLimit: 'Límite Disponible',
  agentDepositRecord: 'Registro de Depósitos de Agente',
  yes: 'Sí',
  no: 'No',
  ...
  inputWithdrawFlowMult: 'Ingresa el Multiplicador de Flujo de Retiro',
