export default {
  ...
  regPage: {
    ...
    isAgree: `Acepto recibir información sobre promociones y actividades de mercado de SEABET`
  },
  thirdRegPage: {
  ...
  advantage: 'Ventajas',
  affiliateQuestion: 'Preguntas Frecuentes',
  overviewDesc:
    'SEABET.IO es la mejor plataforma de apuestas basada en criptomonedas. Ofrecemos una plataforma justa, segura e inclusiva para jugadores interesados en apuestas deportivas en vivo, casinos en vivo y juegos de tragamonedas, con más de 420,000 eventos previos al partido y miles de tragamonedas de video diferentes, mesas de juego y juegos con crupier en vivo desarrollados por proveedores líderes en el mundo. SEABET.IO ha experimentado un crecimiento sin precedentes y te invitamos a formar parte de nuestra historia de éxito.',
  bePartner: 'Conviértete en Socio',
  howBePartner:
    '¡Promociona SEABET.IO y gana hasta un 50% de participación en los ingresos sin cuotas! Ofrecemos servicios en 11 idiomas con gerentes regionales dedicados que apuntan a diferentes partes del mundo.',
  ...
  retentionQ1: '1. ¿Qué es el programa de afiliados?',
  retentionA1:
  ...
  retentionA4: '¡El programa de afiliados de Seabet.io es completamente gratuito! Nuestro objetivo es ayudarte a promocionar nuestra marca y estamos encantados de recompensar tus esfuerzos.',
  retentionQ5: '5. ¿Cómo puedo comenzar a promocionar?',
  retentionA5: 'Puedes promocionar de manera efectiva a través de varios canales sin necesidad de tener tu propio sitio web, como Facebook, Twitter, LinkedIn, Telegram, WhatsApp, foros, etc.',
  retentionQ6: '6. ¿Qué diferencia a Seabet.io de otros sitios web?',
  retentionA6:
    'Seabet.io cumple con todas las expectativas que tendrías de la mayoría de los programas de afiliados. Lo que distingue a Seabet.io son nuestros empleados pioneros. Garantizamos el servicio más rápido posible para nuestros clientes y clientes afiliados, recompensas, lealtad y nuestro servicio multilingüe y global.',
  commission: 'Comisión',
  ...
  commissionQ4: '4. ¿Los saldos negativos se transfieren al próximo mes?',
  commissionA4:
    'Tus comisiones pueden verse afectadas cuando los jugadores que refieres ganan, ya que deducimos esas ganancias de los ingresos. Sin embargo, esta situación generalmente no dura mucho tiempo.',
  commissionQ5: '5. ¿Con qué frecuencia se pagan las comisiones?',
  commissionA5:
    'Tus comisiones de afiliado se pagan automáticamente dentro de los primeros 5 días hábiles de cada mes. Los fondos se agregarán a tu cuenta de jugador y puedes retirarlos o utilizar las comisiones para apostar en el sitio web en cualquier momento.',
  commissionQ6: '6. ¿Puedo referirme a mí mismo?',
  commissionA6: 'No, nuestro programa de afiliados no respalda esta práctica. Se considerará un comportamiento fraudulento.',
  commissionQ7: '7. ¿El programa de afiliados acepta todos los sitios web?',
  commissionA7:
    'No promovemos anuncios para sitios web dirigidos a niños o adultos. Estamos en contra de la publicidad restrictiva; cualquier miembro que utilice estos métodos será excluido de nuestro programa y nos reservamos el derecho de emprender acciones legales contra cualquier miembro que utilice estos sitios web para proteger nuestro sitio. Consulta nuestras reglas y términos para obtener más información.',
  report: 'Informes',
  memberManager: 'Gestión de Miembros',
  commissionReport: 'Informe de Comisiones',
  financeReport: 'Informe Financiero',
  affiliateSupport: 'Soporte',
  advantageTitle: 'Ventajas de SEABET.IO',
  advantageQ1: 'Estadísticas Detalladas',
  advantageA1:
    'Nuestro exclusivo sistema de afiliados te proporciona actualizaciones rápidas y te permite realizar un seguimiento de tus jugadores de línea descendente, ver detalles de los jugadores y datos de enlace.',
  advantageQ2: 'Ganancias de por Vida',
  advantageA2:
    'Como siempre, tus ganancias potenciales son ilimitadas y cuanto más tráfico traigas, más ingresos recibirás. Nuestra generosa estructura de pagos te permite obtener beneficios de cada jugador.',
  advantageQ3: 'Pagos Rápidos de Afiliados',
  advantageA3: 'Pagos rápidos de afiliados. Pagamos comisiones dentro de los primeros 5 días hábiles de cada mes.',
  advantageQ4: 'Marca Líder',
  advantageA4: 'Nos enorgullecemos de ofrecer un excelente servicio y estamos aquí para brindarte más formas de construir una marca líder en el mercado.',
  advantageQ5: 'Asesoramiento Local',
  advantageA5: 'Benefíciate del asesoramiento y la asistencia de nuestros gerentes regionales con más de 10 años de experiencia en la industria del juego en todo el mundo.',
  childMemberList: 'Lista de Miembros de Línea Descendente',
  memberAccount: 'Cuenta de Miembro',
  statTime: 'Estadísticas',
  isBet: '¿Apuesta',
  regTime: 'Registro',
  totalWinLose: 'Ganancia/Pérdida Total',
  lastLoginTime: 'Último Inicio de Sesión',
  bonus: 'Bonificaciones',
  refund: 'Reembolsos',
  venueFee: 'Tarifas del Lugar',
  depositFee: 'Tarifas de Depósito',
  jingWinLose: 'Ganancia/Pérdida Neta',
  accountTz: 'Ajustes de Cuenta',
  manage: 'Gestión',
  dashboard: 'Tablero',
  memberInfo: 'Información del Miembro',
  memberRecord: 'Registros del Miembro',
  memberDeposit: 'Depósitos del Miembro',
  childMember: 'Miembros de Línea Descendente',
  firshRecharge: 'Recuento de Primer Depósito',
  newRegMonth: 'Nuevos Registros de Este Mes',
  newRegValid: 'Nuevos Miembros Válidos',
  activityMemberMonth: 'Miembros Activos de Este Mes',
  winLoseMonth: 'Ganancia/Pérdida Neta de Este Mes',
  dataCompare: 'Comparación de Datos',
  dashAmount: 'Dinero',
  peopleCount: 'Personas',
  regCount: 'Número de Registros',
  firshRechargeCount: 'Recuento de Primer Depósito',
  filter: 'Filtrar',
  agentDepositLimit: 'Dep. Agente Límite',
  canUseLimit: 'Límite Disponible',
  agentDepositRecord: 'Reg. Dep. Agente',
  yes: 'Sí',
  no: 'No',
  childAccount: 'Cuenta de Línea Descendente',
  inputChildAccount: 'Ingresa la Cuenta de Línea Descendente',
  agentDepositAmount: 'Cantidad de Depósito de Agente',
  inputAgentDepositAmount: 'Ingresa la Cantidad de Depósito de Agente',
  singleAgentDepositAmount: 'Cantidad de Depósito Único de Agente',
  agentDepositDayLimit: 'Límite Diario',
  withdrawFlowMult: 'Multiplicador de Flujo de Retiro',
  inputWithdrawFlowMult: 'Multiplicador Retiro',
  multiple: 'Multiplicador',
  remark: 'Observaciones',
  inputRemark: 'Ingresa Observaciones',
  loginPwd: 'Contraseña de Inicio de Sesión',
  inputLoginPwd: 'Ingresa la Contraseña de Inicio de Sesión',
  optime: 'Hora de Operación',
  agentDepositStatus: {
    0: 'Fallido',
    1: 'Exitoso'
  },
  monthDetailsData: 'Datos Detallados Mensuales',
  releaseTime: 'Hora de Liberación',
  activityUser: 'Usuarios Activos',
  netFee: 'Red Tarifas',
  ctfee: 'Tarifas de Depósito/Retiro',
  lastMonthRemain: 'Saldo del Mes Pasado',
  infactCommission: 'Comisiones Reales',
  today: 'Hoy',
  yestoday: 'Ayer',
  currentWeek: 'Semana Actual',
  laskWeek: 'Semana Pasada',
  currentMonth: 'Mes Actual',
  depositDetails: 'Detalles de Depósito',
  withdrawDetails: 'Detalles de Retiro',
  rewardDetails: 'Detalles de Recompensa',
  winLoseTip:
    'Nota: Los números positivos en la ganancia/pérdida total y la ganancia/pérdida neta indican ganancias de la empresa, mientras que los números negativos indican pérdidas de la empresa. Los datos diarios son solo de referencia general y no son el estándar real de pago de comisiones.',
  recommendLink: 'Enlace de Referencia',
  downloadBanner: 'Descargar Banners',
  childAccountNotExist: 'La cuenta de línea descendente no existe',
  depositAmountLimit: 'La cantidad de depósito de agente supera el límite de transacción única',
  withdrawFlowMultLimit: 'El multiplicador de flujo de retiro supera el límite',
  agentDepositSuccess: 'Depósito de agente exitoso',
  mustBeNumber: '{ tmp } debe ser un número',
  inputAccountStart: 'Ingresa la cuenta de miembro para comenzar la búsqueda',
  ...
  keepContact: 'Sigamos en contacto',
  subscribe: `S'ABONNER`,
  ...
  depositNewWindow: 'Estamos a punto de abrir una nueva ventana para su pago.',
  inputDepositAmount: 'Por favor, ingrese el monto de recarga.',
  depositAmountOver: 'El monto de recarga no puede exceder el límite máximo.',
  depositAmountUnder: 'El monto de recarga no debe ser inferior al límite mínimo.',
  providerInfo: 'Por favor, especifica tus datos personales. Todos los datos están encriptados y son seguros.',
  fiatCpfHolder: 'Ingresa el CPF          ',
  fiatName: 'Nombre de la Cuenta',
  fiatNameHolder: 'Ingrese el Nombre',
  fiatPixType: 'Código do Banco',
  fiatPixTypeHolder: 'Elegir Código de Banco',
  fiatPixAccount: 'Cuenta',
  ...
  seabetGame: 'Originales',
  bankScanQr: 'Escaneo QR del Banco',
  ...
  vip: {
    ...
    vipWel: `<p>Bienvenido al Club VIP de Seabet</p>
              <p>En Seabet, estamos comprometidos a mejorar la calidad de los juegos y ofrecer la mejor experiencia de juego. Hemos introducido un nuevo Club VIP para recompensar a nuestros miembros que pasan tiempo jugando en nuestro sitio web de manera fiel.</p>
              <p>Simplemente realiza apuestas en cualquier juego o evento deportivo proporcionado por Seabet.io, y a medida que avances en los rangos, desbloquearás recompensas exclusivas.</p>`,
    vipManage: `<dt>Gerente VIP Exclusivo</dt>
                <dd>A medida para ti</dd>
                <dd>Juegos personalizados</dd>`,
    vipHighReward: ` <dt>Recompensas Altas</dt>
                      <dd>Bonos sin apuesta</dd>
                      <dd>Puntos rápidos</dd>`,
    highLimit: `<dt>Apuestas a Tu Gusto</dt>
                <dd>Transacciones ilimitadas</dd>
              <dd>Máximos más altos</dd>`,
    vipPromotion: `<dt>Promos VIP únicas</dt>
                    <dd>Ofertas a medida</dd>
                    <dd>Solo VIP</dd>`,
    noQueue: `<dt>Servicio 24/7 Superior</dt>
              <dd>Soporte rápido y multilingüe</dd>
              <dd>Tu gerente personal</dd>`,
    vipRewardDetailsTitle: 'Desglose de recompensas VIP',
    vipRewardDetails: `<h2>Desglose de recompensas VIP</h2>
                      <p>¡Sube de nivel para obtener acceso exclusivo a generosas recompensas y regalos personalizados!</p>`,
    subTitle: {
      '102': 'Bronce 1',
      '103': 'Plata 1-5',
      '104': 'Oro 1-8',
    ...
    rewards: {
      '102': {
        '0': { title: 'Bono de Ascenso de Nivel', content: `Premio total: <span>5 USDT</span>` },
        '1': { title: 'Bono de suscripción', content: `Suscríbete al correo promocional y recibe <span>10 USDT</span> gratis` },
        '2': { title: 'Ganancia de Puntos', content: `<p>Apuesta diaria <span>*1%*1</span></p>` },
        '3': { title: 'Slots Deposit Bonus', content: `<p>Obtenga un bono del <span>10%</span> con cada depósito</p>` },
        '4': { title: 'Slots Loss Rebate', content: `<p>Recibe tu bono del <span>5%</span> aproximadamente en base a tus pérdidas diarias</p>` }
      },
      '103': {
        '0': { title: 'Bono de Ascenso de Nivel', content: `Plata 5, Premio total: <span>135 USDT</span>` },
        '1': { title: 'Giros Gratis', content: `<span>30</span> giros gratis en juegos de tragamonedas` },
        '2': { title: 'Ganancia de Puntos', content: `<p>Apuesta diaria <span>*1%*1.1</span></p>` },
        '3': { title: 'Slots Deposit Bonus', content: `<p>Obtenga un bono del <span>11%</span> con cada depósito</p>` },
        '4': { title: 'Slots Loss Rebate', content: `<p>Recibe tu bono del <span>5%</span> aproximadamente en base a tus pérdidas diarias</p>` }
      },
      '104': {
        '0': { title: 'Bono de Ascenso de Nivel', content: `Oro 8, Premio total: <span>1,255 USDT</span>` },
        '1': { title: 'Bono de Recarga', content: `Deposita <span>300 USDT</span>, y recibe <span>300 USDT</span>` },
        '2': { title: 'Ganancia de Puntos', content: `<p>Apuesta diaria <span>*1%*1.2</span></p>` },
        '3': { title: 'Slots Deposit Bonus', content: `<p>Obtenga un bono del <span>11%</span> con cada depósito</p>` },
        '4': { title: 'Slots Loss Rebate', content: `<p>Recibe tu bono del <span>6%</span> aproximadamente en base a tus pérdidas diarias</p>` },
        '5': { title: 'Cashback Semanal', content: `<p>Reciba su bono semanal de Apuesta <span>*1%*5%</span> aproximadamente basado en el monto de su apuesta.</p>` }
      },
      '105': {
        '0': { title: 'Bono de Ascenso de Nivel', content: `Platino 10, Premio total: <span>6,025 USDT</span>` },
        '1': { title: 'Bono de Recarga', content: `Deposita <span>1,000 USDT</span>, y recibe <span>1,000 USDT</span>` },
        '2': { title: 'Ganancia de Puntos', content: `<p>Apuesta diaria <span>*1%*1.3</span></p>` },
        '3': { title: 'Slots Deposit Bonus', content: `<p>Obtenga un bono del <span>12%</span> con cada depósito</p>` },
        '4': { title: 'Slots Loss Rebate', content: `<p>Recibe tu bono del <span>7%</span> aproximadamente en base a tus pérdidas diarias</p>` },
        '5': { title: 'Cashback Semanal', content: `<p>Reciba su bono semanal de Apuesta <span>*1%*5%</span> aproximadamente basado en el monto de su apuesta.</p>` },
        '6': { title: 'Cashback Mensual', content: `<p>Reciba su bono mensual de Apuesta <span>*1%*3%</span> aproximadamente basado en el monto de su apuesta.</p>` }
      },
      '106': {
        '0': { title: 'Bono de Ascenso de Nivel', content: `Titanio 10, Premio total: <span>18,555 USDT</span>` },
        '1': { title: 'Bono de Recarga', content: `Deposita <span>3,000 USDT</span>, y recibe <span>3,000 USDT</span>` },
        '2': { title: 'Ganancia de Puntos', content: `<p>Apuesta diaria <span>*1%*1.5</span></p>` },
        '3': { title: 'Slots Deposit Bonus', content: `<p>Obtenga un bono del <span>12%</span> con cada depósito</p>` },
        '4': { title: 'Slots Loss Rebate', content: `<p>Recibe tu bono del <span>8%</span> aproximadamente en base a tus pérdidas diarias</p>` },
        '5': { title: 'Cashback Semanal', content: `<p>Reciba su bono semanal de Apuesta <span>*1%*8%</span> aproximadamente basado en el monto de su apuesta.</p>` },
        '6': { title: 'Cashback Mensual', content: `<p>Reciba su bono mensual de Apuesta <span>*1%*5%</span> aproximadamente basado en el monto de su apuesta.</p>` }
      },
      '107': {
        '0': { title: 'Bono de Ascenso de Nivel', content: `Diamante 6, Premio total: <span>105,555 USDT</span>` },
        '1': { title: 'Bono de Recarga', content: `Deposita <span>10,000 USDT</span>, y recibe <span>10,000 USDT</span>` },
        '2': { title: 'Ganancia de Puntos', content: `<p>Apuesta diaria <span>*1%*2</span></p>` },
        '3': { title: 'Slots Deposit Bonus', content: `<p>Obtenga un bono del <span>15%</span> con cada depósito</p>` },
        '4': { title: 'Slots Loss Rebate', content: `<p>Recibe tu bono del <span>10%</span> aproximadamente en base a tus pérdidas diarias</p>` },
        '5': { title: 'Cashback Semanal', content: `<p>Reciba su bono semanal de Apuesta <span>*1%*10%</span> aproximadamente basado en el monto de su apuesta.</p>` },
        '6': { title: 'Cashback Mensual', content: `<p>Reciba su bono mensual de Apuesta <span>*1%*8%</span> aproximadamente basado en el monto de su apuesta.</p>` },
        '7': { title: 'Recompensa Especial', content: `<p>Diamante 6, recompensa especial de Honra Suprema de <span>20,000 USDT</span></p>` }
      }
    },
    vipRewardDetailTitle: 'Detalles de los Beneficios del Club VIP',
    vipRewardDetailContent: `<dd>Los bonos de correo electrónico de promoción por suscripción se enviarán a través del correo electrónico promocional con un código. Utiliza el código para canjearlo en la página de "Recompensas".</dd>
                            <dd>Giros gratis para VIPs Plata se pueden reclamar en la página de 'Recompensas'. Disponibles en la plataforma Play'N GO, juegos elegibles: Moon Princess Trinity/Honey Rush 100/Hotel Yeti-Way./dd>
                            <dd>Por favor, revise la página de promociones para más información sobre Slots Deposit Bonus ＆ Slots Loss Rebate.</dd>
                            <dd>Los bonos de recarga para todos los niveles están limitados a una solicitud, requiriendo la realización de una cantidad de apuestas 10 veces, aplicable a cualquier juego. Ejemplo: (1000+1000)*10=20000.</dd>
                            <dd>Los bonos de recarga deben solicitarse a través del servicio de atención al cliente en línea después de completar el depósito y antes de realizar cualquier apuesta.</dd>
                            <dd>Las recompensas en puntos se añadirán automáticamente a la cuenta al día siguiente en función del monto apostado.</dd>
                            <dd>Los bonos semanales y mensuales se añadirán automáticamente a la cuenta en un plazo de 48 horas después del inicio de la próxima semana o mes.</dd>
                            <dd>Todos los períodos de cálculo de bonos se realizarán utilizando la Hora de Hong Kong, Hong Kong, China (UTC+8).</dd>`,
    howBeVipTitle: 'Cómo convertirse en nuestro miembro VIP',
    howBeVipContent: ` <dd>
                          Continuar Apostando: La clave para convertirse en VIP es apostar de manera constante en varios eventos deportivos y juegos de casino. Seabet recompensa tu consistencia. Como uno de los principales sitios web de apuestas con criptomonedas, utiliza regularmente tus activos digitales para apostar en cualquiera de los eventos y juegos de casino que ofrece Seabet. También puedes probar las apuestas en USDT y seguir utilizando tus fondos.
                      </dd>
                      <dd>
                        Participar en Eventos Regulares: Las promociones de Seabet incluyen diversas actividades y concursos en los que puedes participar en cualquier momento. Participar regularmente en cualquiera de estas actividades aumentará tus posibilidades de recibir una invitación al Club VIP. Además, también puedes volverte más activo en otras funciones del club de Seabet.
                      </dd>
                      <dd>Esperar la Invitación: Lo último que necesitas hacer es esperar a que te enviemos una invitación. Sigue jugando y participando en eventos de alto nivel. Después de algunas rondas de juegos de casino y apuestas deportivas, una vez que se te considere digno de ser miembro del Club VIP, recibirás una invitación de inmediato.</dd>
                      <dd>
                        Experimenta la Vida de Lujo como VIP de Seabet: Lleva tu experiencia de apuestas en USDT a un nivel completamente nuevo mientras disfrutas de los privilegios de ser miembro del Club VIP de Seabet. Cuando participas en apuestas deportivas y juegos de casino, como jugador valorado, puedes disfrutar de lo mejor en apuestas divertidas, rápidas y justas.
                      </dd>`
  },
  ...
  problem: {
    ...
    everyGetInterial: '6.¿Puedo ganar puntos del club con cada apuesta?',
  ...
  errorCodes: {
    ...
    1042: 'Su función de retiro está temporalmente deshabilitada.',
    1043: 'Error de formato de dirección de billetera'
  },
