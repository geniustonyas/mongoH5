...
export const providerList = [
  // 体育提供商
  { id: '1', type: 'sports', tab: 'sports', name: t('provider.sabaSports'), img: getAssetsFile('svg/SabaSports.svg') },
  { id: '2', type: 'sports', tab: 'sports', name: t('provider.fbSports'), img: getAssetsFile('svg/FBSports.svg') },
  // 真人提供商
  { id: '3', type: 'casino', tab: 'casino', name: t('provider.evolution'), img: getAssetsFile('svg/Evolution.svg') },
  { id: '4', type: 'casino', tab: 'casino', name: t('provider.bombayLive'), img: getAssetsFile('svg/BombayLive.svg') },
  { id: '5', type: 'casino', tab: 'casino', name: t('provider.ezugi'), img: getAssetsFile('svg/Ezugi.svg') },
  { id: '6', type: 'casino', tab: 'casino', name: t('provider.asiaGaming'), img: getAssetsFile('svg/AsiaGaming.svg') },
  // 电子提供商
