<template>
  ...
  <nav class="m-term">
    ...
    <dl>
      ...
      <dd>
        <a target="_blank" href="https://twitter.com/bet_sea6635">Twitter <i class="iconfont icon-share" /></a>
      </dd>
      <dd>
      ...
      <dd>
        <a target="_blank" href="https://www.tiktok.com/@seabio00?lang=en">Tiktok <i class="iconfont icon-share" /></a>
      </dd>
    </dl>
    <dl>
      <dt>{{ t('support2') }}</dt>
